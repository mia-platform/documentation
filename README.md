...
Per aggiungere informazioni è sufficiente seguire i seguenti passi:
 ...
 - creare un branch con il nome `prefix-name`  
    ...
    - prefix: può essere `edit` se stai cambiando una pagina, `new` se stai lavorando ad una nuova sezione che è già in produzione, `prj` se stai scrivendo la documentazione per un progetto non ancora approvato
