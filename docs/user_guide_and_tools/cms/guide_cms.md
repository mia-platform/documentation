...
![image alt text](\user_guide_and_tools\img\image_0.png)
...
![image alt text](\user_guide_and_tools\img\image_1.png)
...
![image alt text](\user_guide_and_tools\img\image_2.png)
...
![image alt text](\user_guide_and_tools\img\image_3.png)
...
![image alt text]\(user_guide_and_tools\img\image_4.png)
...
![image alt text](\user_guide_and_tools\img\image_5.png)
...
![image alt text](\user_guide_and_tools\img\image_6.png)

Una volta creata e salvata la scheda libro, questa sarà in draft oppure direttamente pubblicata.

Lo si riconosce dal simbolo![image alt text](\user_guide_and_tools\img\image_7.png)(draft) oppure ![image alt text](\user_guide_and_tools\img\image_8.png) (publish) .
...
![image alt text](\user_guide_and_tools\img\image_9.png)
...
![image alt text](\user_guide_and_tools\img\image_10.png)
...
![image alt text](\user_guide_and_tools\img\image_11.png)
...
![image alt text](\user_guide_and_tools\img\image_12.png)
...
![image alt text](\user_guide_and_tools\img\image_13.png)
...
![image alt text](\user_guide_and_tools\img\image_14.png)
...
![image alt text](\user_guide_and_tools\img\image_15.png)
...
![image alt text](\user_guide_and_tools\img\image_16.png)
...
![image alt text](\user_guide_and_tools\img\image_17.png)
...
### ![image alt text](\user_guide_and_tools\img\image_21.png)

### Campi di selezione

![image alt text](\user_guide_and_tools\img\image_22.png)

### Campi required

Sono i campi obbligatori che se non popolati impediscono di salvare l’elemento. Sono contrassegnati dall’asterisco.

![image alt text](\user_guide_and_tools\img\image_23.png)
...
![image alt text](\user_guide_and_tools\img\image_24.png)

### I campi data

![image alt text](\user_guide_and_tools\img\image_25.png)

### Bottone di caricamento allegati

![image alt text](\user_guide_and_tools\img\image_26.png)
...
![image alt text](\user_guide_and_tools\img\image_27.png)

![image alt text](\user_guide_and_tools\img\image_28.png)
...
![image alt text](\user_guide_and_tools\img\image_29.png)
