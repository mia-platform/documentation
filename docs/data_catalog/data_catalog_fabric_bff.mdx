...
Moreover, the BFF exposes API to manage Data Catalog Connections from the [dedicated UI section](/data_catalog/frontend/data_catalog_connections.mdx).
...
| `/job-runner/*`              | REST      | *      | Routes prefixed with `/job-runner` are converted into gRPC requests towards Job Runner service.<br/> For more details please read [corresponding documentation](/data_catalog/data_catalog_open_lineage.mdx#endpoints)|
