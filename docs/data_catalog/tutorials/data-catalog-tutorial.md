...
:::note
In this tutorial, Okta has been chosen as the Identity Provider for managing user identities. Any other Identity Provider supported by the Mia-Platform [Authentication Service](/runtime_components/plugins/authentication-service/10_overview.md) can be adopted in place of Okta by following the same guide steps.
:::
