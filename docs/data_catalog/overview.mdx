...
## Mia-Platform Data Catalog - Key features
...
* Data Catalog Application (LINK TO ITEM MARKETPLACE DOCS TO BE INSERTED), that offers pre-configured bundle of resources that allows you to easily instantiate and deploy a working Data Catalog product. Give a look at the following [documentation page](/data_catalog/data_catalog_frontend.mdx) to see how to navigate Mia-Platform Data Catalog.
* Data Catalog Agent (LINK TO ITEM MARKETPLACE DOCS TO BE INSERTED), that is in charge of extracting metadata regarding the several tables and data structures existing on configured
