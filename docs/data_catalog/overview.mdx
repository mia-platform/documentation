...
- visit the dedicated [documentation page](/data_catalog/data_catalog_job_runner.mdx) for configuring the Data Catalog Job Runner to keep your Data Catalog up to date with your data sources;
