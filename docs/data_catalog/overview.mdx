...
In order to help companies solve all these challenges, we offer Mia-Platform Data Catalog, a core component of Mia-Platform products suite and a powerful tool for the Data Governance.  
With Mia-Platform, it is possible to take advantage of the synergies among the data products Data Catalog and Fast Data, paving the way to the implementation of a Data Fabric solution.

![Data Catalog UI](./img/data_catalog_home.png)

Mia-Platform Data Catalog offers many powerful features for your Data Product:
