...
* [Data Catalog Agent](/runtime_suite_templates/data-catalog/10_overview.md), that is in charge of extracting metadata regarding the several tables and data structures existing on configured
