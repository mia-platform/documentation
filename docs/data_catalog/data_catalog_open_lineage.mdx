...
Open Lineage service provides Catalog feautres and Data Lineage features to the Data Catalog UI.
...
<details>
<summary>Data Catalog routes</summary>

The following routes are exposed over the `/data-catalog/*` base path.
...
<details>
<summary>Open Lineage routes</summary>

The following routes are exposed over the `/open-lineage/*` base path.
...
| `/dataset/items`                                           | REST | POST   | Create a virtal dataset.                                                                                  |
...
Add the `/open-lineage/*` endpoints to your project's configuration, along with their permissions. 