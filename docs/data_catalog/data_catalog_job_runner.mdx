...
QueryTimeout=T
ResultSets=T
# 👇 ...here goes the DBQ field of the connection string
ServerName= 
...
With Oracle databases, connectivity can be handled with [`tnsnames.ora` files and/or wallets](https://docs.oracle.com/cd/B28359_01/network.111/b28317/tnsnames.htm#NETRF007).
...
- `OdbcClient`: service responsible to retrieve information about the status of the ODBC driver
...
- `Configuration`: service responsible to retrieve information about the main configuration of the service.
...
- `JobRunner`: service responsible to interact with the JobRunner service:
