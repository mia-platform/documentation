...
:::warning
This section of the Data Catalog application has been __deprecated__. Instead of manually configuring the Cronjob, 
Data Catalog UI now provides a section for [Connection Management](/data_catalog/frontend/data_catalog_connections.mdx), 
which interacts with [Fabric BFF](/data_catalog/data_catalog_fabric_bff.mdx) and [Job Runner](/data_catalog/data_catalog_job_runner.mdx) services.
:::
