...
- access to \[Data Catalog\](TODO: PUT LINK) application, which automatically
...
:::tip
In case it is needed to \[embed Data Catalog solution within Mia-Platform Console\](TODO: PUT LINK),
...
<details>
<summary>Data Catalog Users Collection Definition (import ready)</summary>
...
:::note
Before proceeding, be sure to have configured Data Catalog endpoints accordingly to their \[specific documentation\](TODO: PUT LINK).
:::
...
The permissions described in the table above needs then to be applied to all the different routes exposed by Data Catalog application,
...
| /tags                                                    | REST | GET    | `permissions["read:data-assets"]`       |
...
| /metadata-registry/                                      | REST | GET    | `permissions["read:data-assets"]`       |
| /metadata-registry/                                      | REST | POST   | `permissions["update:metadata-assets"]` |
| /metadata-registry/:name                                 | REST | GET    | `permissions["read:data-assets"]`       |
| /metadata-registry/:name                                 | REST | PATCH  | `permissions["update:metadata-assets"]` |
| /metadata-registry/:name                                 | REST | DELETE | `permissions["update:metadata-assets"]` |
...
<details>
<summary>Data Catalog Users Page</summary>
