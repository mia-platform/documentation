...
Mia-Platform Data Catalog frontend offers  

The frontend offers a user-friendly UI having:
...
* a [Data Lineage section](/data_catalog/frontend/data_lineage.mdx) that allows users to create relations between real and virtual assets;
