...
- __Connection Creation__: the UI provides a creation wizard that let users define a new connection that contributes to Data Catalog assets;
...
data models stored on MongoDB through [Crud Service](/runtime_suite/crud-service/10_overview_and_usage.md).
