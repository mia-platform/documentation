...
In case the user wants to easily move from table "TO-BE-CORRECTLY-NAMED" to SoR "TO-BE-CORRECTLY-NAMED" without coming back to the search page to find "TO-BE-CORRECTLY-NAMED" asset, with a simple click on "TO-BE-CORRECTLY-NAMED" user can enter its detail page.
