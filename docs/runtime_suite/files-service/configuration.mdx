...
In addition, after each upload it saves the file's information using the [CRUD Service](../../runtime_suite/crud-service/configuration) on a configurable mongoDB collection (usually files).
