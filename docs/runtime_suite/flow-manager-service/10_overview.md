...
:::tip
Checkout the [Flow Manager Configurator](/development_suite/api-console/api-design/flow-manager-configurator/overview.md): a tool to easily generate the configuration file of the service.
:::
