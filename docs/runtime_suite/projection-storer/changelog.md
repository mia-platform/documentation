...
This is the initial release of Projection Storer service. A brief overview regarding the service can be found [here](../docs/fast_data/projection_storer)
while an in depth explanation describing how to configure the service can be found [here](../docs/fast_data/configuration/projection_storer_config)
