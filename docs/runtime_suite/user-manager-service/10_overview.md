...
Leveraging the [CRUD Service](../crud-service/10_overview_and_usage.md) and the desired authentication service
(for instance, the [Auth0 Client](../auth0-client/10_overview_and_usage.md)),
...
- it supports the adoption of data encryption: properties can easily be encrypted in the [CRUD](../crud-service/30_encryption_configuration.md);
...
:::note
At this time the [Auth0 Client](../auth0-client/10_overview_and_usage.md) microservice is the only authentication service available,
