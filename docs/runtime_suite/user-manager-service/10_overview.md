...
Leveraging the [CRUD Service](../crud-service/overview_and_usage) and the desired authentication service
(for instance, the [Auth0 Client](../auth0-client/overview_and_usage)),
...
- it supports the adoption of data encryption: properties can easily be encrypted in the [CRUD](../crud-service/encryption_configuration);
...
:::note
At this time the [Auth0 Client](../auth0-client/overview_and_usage) microservice is the only authentication service available,
