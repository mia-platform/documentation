...
In order to open the `ck-add-plan-modal` in a Backoffice, a configuration is needed to configure a button to emit the custom event [`add-plan-modal`](../30_events.md#addplanmodal). An example configuration follows: 
...
|[selected-data](../../../business_suite/back-kit/events#selected-data)| Triggers the opening of the modal in edit mod | add-plan-modal | - |
