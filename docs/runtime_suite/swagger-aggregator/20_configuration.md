...
- `/documentations/api-portal/api`: this endpoint is necessary to retrieve the aggregated Open API specification document shown in the [Documentation Portal](../../development_suite/api-portal/api-documentations) through the graphical interface generated by the [API Portal](../../runtime_suite/api-portal/overview) plugin.
