...
Kafka messages will be produced following the [message adapter DB2](../../fast_data/configuration/realtime_updater/common#kafka-adapters-kafka-messages-format) standard.
