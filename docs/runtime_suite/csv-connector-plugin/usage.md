...
Kafka messages will be produced following the [message adapter DB2](/fast_data/configuration/realtime_updater/realtime_updater_v7.md#message-adapters) standard.
