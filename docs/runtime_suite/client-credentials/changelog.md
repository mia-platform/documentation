...
- added environment variable `ADDITIONAL_HEADERS_TO_PROXY` to specify additional headers to be proxied and envar `USERID_HEADER_KEY` to specify the header key holding the user identifier.
