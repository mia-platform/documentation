...
The [Mia-Backoffice](../../business_suite/backoffice/overview) can be used to manage the different style assets. In case you require supporting files, you will need to configure a [Files Service](../files-service/configuration) instance in your project and update the Mia-Backoffice configuration to use it's [File Manager](../../business_suite/backoffice/back-kit/components/clients#file-manager) client.  
