...
| CRUD_LIMIT_CONSTRAINT_ENABLED | Boolean | Optional | `true`                                    | Enables the query limit constraint feature. If it is enabled, the max limit of the GET list APIs is 200.                                                                       |
