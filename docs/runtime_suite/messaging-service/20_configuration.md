...
- **pushTitle (required)** - `string`: title of the notification. It supports [interpolation][message-interpolation].

- **pushSubtitle** - `string`: subtitle of the notification. It supports [interpolation][message-interpolation].

- **pushMessage (required)** - `string`: message of the notification. It supports [interpolation][message-interpolation].
