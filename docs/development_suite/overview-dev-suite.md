...
Get started with your project in a few clicks: configure Kubernetes clusters, set up your environments and manage all the [environment variables](development_suite/set-up-infrastructure/env-var.md).
