...
In the **Settings** section you will find Company-specific information and settings, such as an overview of the Company's basic information and configurations, and the possibility to handle feature activations or perform sensitive operations.
