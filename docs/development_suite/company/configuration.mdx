...
- **environments** (_required_):
  ...
  - **environmentsVariables**: an object that describes the configuration of variables for the environment.
    ...
    :::info
    This field can be overriden by the configuration provided in the `environmentsVariables` field for a specific environment. 
    :::
  ...
  - **deploy**: an object that describes the configuration of CI/CD pipelines for the environment.
    ...
    :::info
    This field can be overriden by the configuration provided in the `pipelines` field for a specific environment. 
    :::
