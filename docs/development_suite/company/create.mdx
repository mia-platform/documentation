...
- `imagePullSecretNames`: a list of imagePullSecret names that will be inherited in the project during project creation and then used in deployment and cronjob files for pulling docker inages
