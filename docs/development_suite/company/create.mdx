...
- [clusters](/development_suite/clusters-management/clusters-overview-setup.md)
- [providers](/development_suite/set-up-infrastructure/configure-provider.mdx) (Git Providers, Secret Managers, CI/CD Tools)
...
For further details on how to create new providers, you can follow the [providers configuration guide](/development_suite/set-up-infrastructure/configure-provider.mdx).
...
- **repository** (_required_):
  ...
  :::info
  This field can also be set by [selecting a default Git Provider](/development_suite/set-up-infrastructure/configure-provider.mdx#set-a-default-provider) in the **Providers** section of the Console.
  :::
  ...
  - **providerId** (_required_): the unique identifier of the Git Provider associated with the company 
    ...
    It corresponds to the `providerId` field of the providers' CRUD collection, and it is used to retrieve information about the provider. 

    Check out the complete list of [supported providers](/development_suite/set-up-infrastructure/configure-provider.mdx);
...
- **pipelines** (_required_):
  ...
  :::info
  This field can also be set by [selecting a default CI/CD Tool](/development_suite/set-up-infrastructure/configure-provider.mdx#set-a-default-provider) in the **Providers** section of the Console.
  :::
  ...
  - **type** (_required_): one of the supported provider types. Check out the complete list of [supported providers](/development_suite/set-up-infrastructure/configure-provider.mdx);
...
- **environmentsVariables**:
  ...
  :::info
  This field can also be set by [selecting a default Secret Manager](/development_suite/set-up-infrastructure/configure-provider.mdx#set-a-default-provider) in the **Providers** section of the Console.
  :::
  ...
  - **storage**: additional settings related to the storage of environment variables within the GitLab installation.
    ...
    - **path**: specifies the exact location for reading variables, starting from the _basePath_.

    - **type**: the level of granularity variables are managed in the GitLab installation.
...
- **environments** (_required_):
  ...
  - **deploy**: an object that describes the configuration of CI/CD pipelines for the environment.
    ...
    <TabItem value="github" label="Github">
     ...
     - **statusWebhookSecretCredentialsId**: the identifier of a secret credential that is used to authenticate and authorize access to a status webhook.

     A status webhook is a mechanism that allows external services or systems to receive notifications about the status of GitHub Actions workflows or specific events within a repository.
...
- **logicalScopeLayers**:
  ...
  The `logicalScopeLayers` field will be created in the project model according to the project `layerId` value. Please refer to the [Create a Project](/development_suite/set-up-infrastructure/create-project.mdx) section for further details.
