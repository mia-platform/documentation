...
Additionaly, Provider credentials won't be shared with other Companies at any time.
...
This step has no differencies with the [Connect a provider Step 3](#step-3-credentials)

### Step 4: Advanced

This step has no differencies with the [Connect a provider Step 4](#step-4-advanced)
