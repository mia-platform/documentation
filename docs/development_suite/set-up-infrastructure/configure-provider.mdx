...
:::info
For mor specific details on how to connect a Provider for Marketplace, please refer to the [dedicated paragraph](#connect-a-provider-for-marketplace) later on this page.
:::

After clicking on it a modal will show up, and, through a few steps, you will be asked to enter some information related to the provider.
...
If you are creating a new Provider for Marketplace, you will also see an additional toggle, which allows you to manage the accessibility to the Provider.
...
If you have a Git Provider with the "Marketplace" functionality selected, you are going to make available to the other Companies all the resources connected to that specific Git Provider.  
This action is reversible: you can manage the accessibility to that Git Provider at any time, by simply switching off the accessibility toggle. 
...
Doing so, you will be able to decide to make available to other Companies any resource connected to that specific Provider.

![Provider overview Marketplace](img/providers-overview-marketplace.png)

The process of creating a Provider for Marketplace is the same as the one described in the [Connect a Provider](#connect-a-provider) section, with only small differences in the first step and second step of the process.
...
you will be able to select only Providers that allows the "Marketplace" functionality.

![Add Provider Connection For Marketplace](img/add-provider-1-marketplace.png)

:::info
Only Providers with Git-Provider capability allow the "Marketplace" functionality.
:::
...
Enabling or Disabling this toggle you will be able to manage the accessibility to the Provider. 
**When enabled, this toggle allows other Companies to access this Provider related resources**.

:::note
Provider credentials won't be shared with other Companies at any time.
:::
