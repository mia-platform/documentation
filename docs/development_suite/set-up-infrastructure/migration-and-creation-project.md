...
In order to have some project with Enhanced Workflow, you can create new projects with the feature already enabled or you can migrate some existing projects on which you are administrator from the Standard to the Enhanced Workflow.
...
:::info
Disabling the `Enable the Enhanced Project Workflow` switch, it is still possible to create new project with the Standard Workflow
:::
