      ...
      "items": {
        ...
        "properties": {
          ...
          "dashboards": {
            ...
            "items": {
              ...
              "properties": {
                ...
                "label": { "type": "string" },
                "url": { "type": "string" },
                "type": { "type": "string", "enum": ["iframe", "newTab"], "default": "iframe" },
                "category": {
                  "type": "object",
                  "properties": {
                    "label": { "type": "string" },
          ...
          "environmentsVariables": {
            "type": "object",
            "properties": {
              "type": { "type": "string", "enum": ["gitlab", "vault"] },
              "providerId": { "type": "string" },
              "baseUrl": { "type": "string" },
              "storage": {
                "type": "object",
                "properties": {
                  "type": { "type": "string", "enum": ["groups", "projects"] },
                  "path": { "type": "string" },
                  "id": { "type": "string" },
                },
        ...
        "oneOf": [
          ...
          },
          {
            ...
            "properties": {
              "path": { "type": "string" },
              "isBackoffice": { "type": "boolean" },
              "isEnvironmentLink": { "type": "boolean" },
            },
            "required": ["path"],
            "additionalProperties": false,
          },
      ...
      "anyOf": [
        {
          "type": "object",
          "properties": {
            "type": { "type": "string", "enum": ["REPOSITORY", "PROJECT_ID"] },
          },
          "required": ["type"],
          "additionalProperties": false,
        },
        {
          "type": "object",
          "properties": {
            "type": { "type": "string", "enum": ["CONSTANT_PREFIX"] },
            "prefix": { "type": "string" },
          },
    ...
    "pipelines": {
      "oneOf": [
        ...
        },
        {
          ...
          "properties": {
            "providerId": { "type": "string" },
            "type": { "type": "string", "enum": ["azure-pipelines"] },
