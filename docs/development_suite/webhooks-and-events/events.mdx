...
<TabItem value="project-schema" label="Schema">
...
| `defaultConfigMaps`                    | `array`  | The default config maps configured by marketplace item                                                                                                  |
...
| `defaultSecrets`                       | `array`  | The default secrets configured by marketplace item                                                                                                      |
...
<TabItem value="service-schema" label="Schema">
