...
| `service`       | `object` | [The service metadata](#service) (ideally, the whole service resource)                                   |
...
| ---------------------- | -------- | -------------------------------------------------------------------------------------------- |
| `_id`                  | `string` | The unique idetifier of project created                                                      |
...
#### Only in `project_created` event

|        Property        |   Type    |                                          Description                                          |
| ---------------------- | --------- | --------------------------------------------------------------------------------------------- |
| `areNamespacesCreated` | `array`   | For any environment set to tenant environments, you can find the result of each creation here |
| `isRepositoryCreated`  | `boolean` | The result of creation into repository git                                                    |
...
<Tabs>
<TabItem value="service-table" label="Entity">

|                Property                |   Type   |                                                                       Description                                                                       |
| -------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `containerPorts`                       | `array`  | The container port                                                                                                                                      |
| `defaultArgs`                          | `array`  | The default container args                                                                                                                              |
| `defaultConfigMaps`                    | `array`  | The default config maps that will be mounted inside the container of the microservice                                                                                                  |
| `defaultDocumentationPath`             | `string` | The name of the service inside the project configuration                                                                                                |
| `dockerImage`                          | `string` | The service url of docker image                                                                                                                         |
| `defaultLogParser`                     | `string` | The [Log parser](/getting_started/monitoring-dashboard/dev_ops_guide/log.md#log-parsers)                                                         |
| `defaultMonitoring`                    | `object` | The object which describes the [monitoring tools supported](/development_suite/api-console/api-design/microservice-monitoring.md) by the project |
| `defaultEnvironmentVariables`          | `array`  | The environment variables configured by marketplace item                                                                                                |
| `defaultProbes`                        | `object` | The default [probes](/development_suite/api-console/api-design/microservice-runtime-resources.md#probes) used by containers                      |
| `defaultResources`                     | `object` | The default resources configured by marketplace item                                                                                                    |
| `defaultSecrets`                       | `array`  | The default secrets that will be mounted inside the container of the microservice                                                                                                      |
| `defaultTerminationGracePeriodSeconds` | `number` | The default graceful shutdown configured by marketplace item                                                                                            |
| `description`                          | `string` | The service description                                                                                                                                 |
| `repoId`                               | `number` | The git repository id                                                                                                                                   |
| `resourceName`                         | `string` | The name of marketplace item use to generate the service                                                                                                |
| `sshUrl`                               | `string` | The ssh URL of repository folder                                                                                                                        |
| `webUrl`                               | `string` | The web URL of repository folder                                                                                                                        |

</TabItem>
<TabItem value="service-example" label="Example">
...
<TabItem value="service-schema" label="JSON Schema">
