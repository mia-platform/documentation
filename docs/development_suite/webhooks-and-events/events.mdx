...
:::note
This event does not guarantee that the user in question already has an higher-priviledged access to the resource via another group, or directly.
:::
