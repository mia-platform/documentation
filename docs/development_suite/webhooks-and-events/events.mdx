...
### User added to Company <small><Tag label={'v12.1.0'} /></small>
...
### User Company role edited <small><Tag label={'v12.1.0'} /></small>
...
### User removed from Company <small><Tag label={'v12.1.0'} /></small>
...
### User added to Project <small><Tag label={'v12.1.0'} /></small>
...
### User removed from Project <small><Tag label={'v12.1.0'} /></small>
