...
All the events emitted by the Console share some common properties:
...
### Project created event: `project_created`

This event will be emitted when a project is created successfully.
    ...
    "properties": {
      ...
      "payload": {
        ...
        "properties": {
          ...
          "tenantId": {
            "type": "string",
            "description": "The identifier of the tenant to which the project belongs"
          }
        },
...
### Service created event: `service_created`

This event will be emitted when a service is generated successfully from a marketplace template or example.

Notice that the event is emitted as soon as the service's repository is successfully created, hence there is no guarantee that the service will be found into the project configuration.
    ...
    "properties": {
      ...
      "payload": {
        ...
        "properties": {
          "tenantId": {
            "type": "string",
            "description": "The identifier of the tenant to which the service belongs"
          },
          "projectId": {
            "type": "string",
            "description": "The identifier of the project to which the service belongs"
          },
          "repositoryURL": {
            "type": "string",
