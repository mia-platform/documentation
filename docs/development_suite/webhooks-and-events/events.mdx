...
:::note
The event is triggered as soon as the service's repository is successfully created, hence there is no guarantee that the service will be found into the project configuration, yet.
:::
