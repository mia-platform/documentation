...
Inside the file, you need to add the **envs** field inside the service you want to modify. The **envs** field is a JSON object and must contain the `key: value` pairs with the environment variables you want to add.
