...
In the Console, follow these steps:
 ...
 3. Select a Template and add the Microservice information:
      ...
      * **Docker image name**: the docker image name, you can leave the default one too. You can choose the Container Registry from a dropdown list, which contains the [Container Registries configured in the Project Settings](/docs/console/project-configuration/project-settings#container-registries).
