...
:::info
Check out [this page](/development_suite/api-console/advanced-section/dev-console-config.md#change-the-number-of-replicas) for manually set the number of replicas of a Platform Services  
:::
