...
An endpoint allows you to expose your CRUD, services, and proxies. To quickly create an endpoint linked to a CRUD, you can follow the steps described in [Design QuickStart page](/getting-started/tutorials/rest-api/quick-rest-api.mdx).
