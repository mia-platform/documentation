...
An endpoint allows you to expose your CRUD, services and proxies. To rapidly create an endpoint linked to a CRUD, you can follow the steps described in [Design QuickStart page](../../../tutorial/rest_api/quick_rest_api).
