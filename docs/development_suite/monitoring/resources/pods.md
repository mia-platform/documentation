...
:::info
Check out the [Guidelines for logs](/getting-started/guidelines/guidelines-for-logs.md) to know how to guarantee uniformity in the logs generated by your services, in order to ensure easy and effective usage.
:::
