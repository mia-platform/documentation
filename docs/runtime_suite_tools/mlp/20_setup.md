...
```sh
go install github.com/mia-platform/mlp@v2.0.0-beta.2
```

Or like this if the `install` command is not available

```sh
go get -u github.com/mia-platform/mlp@v2.0.0-beta.2
```
...
```sh
curl -fsSL https://github.com/mia-platform/mlp/releases/download/v2.0.0-beta.2/mlp-linux-amd64 -o /tmp/mlp
```

```sh
wget -q https://github.com/mia-platform/mlp/releases/download/v2.0.0-beta.2/mlp-linux-amd64 -O /tmp/mlp
```
...
```sh
docker run ghcr.io/mia-platform/mlp:v2.0.0-beta.2
```
