...
To know more about user synchronization with an Identity Provider, visit the [dedicated documentation page](/infrastructure/self-hosted/synchronize-users.md).
