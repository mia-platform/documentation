...
To know how to manage private runtime clusters using BYOI model check the [dedicated documentation page](/infrastructure/self-hosted/private-clusters.mdx).
