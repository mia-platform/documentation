...
Rönd helps you to decouple actions that user can perform (generally known as *permissions*) and their higher-level Role inside an information system.
...
In this tutorial we will see how to add this [authorization layer](/development_suite/api-console/api-design/rbac.md) to our [Endpoints](/development_suite/api-console/api-design/endpoints.md). 
...
If you don't have it yet, you can easily set it up following the [Create a Rest API in 5 minutes](/tutorial/rest_api/quick_rest_api.md) guide
