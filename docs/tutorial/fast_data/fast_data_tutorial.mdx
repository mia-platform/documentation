...
3. In the dialog, choose the name (System ID) and the Kafka message format of the SoR (choose the format you want to use for the messages sent on the Kafka topics) and then click on "Go to system page";
