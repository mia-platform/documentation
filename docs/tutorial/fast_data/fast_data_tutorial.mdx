...
There are other parameters that we can configure. If you need to know more about the parameters of the microservice, you can [read the documentation of the Real-Time Updater](/fast_data/configuration/realtime_updater).
...
There are other parameters that we can configure. If you need to know more about the parameters of the microservice, you can [read the documentation of the Single View Creator](/fast_data/configuration/single_view_creator#environment-variables).
