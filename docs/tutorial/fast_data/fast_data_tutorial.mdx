...
Before starting this tutorial, you need to be familiar with the concepts of [Fast Data architecture](../../../docs/fast_data/overview), including [Projections](../../../docs/fast_data/create_projection), [Single View](../../../docs/fast_data/single_view), and Kafka (including producers and consumers).
...
There are other parameters that we can configure. If you need to know more about the parameters of the microservice, you can [read the documentation of the Real-Time Updater](../../../docs/fast_data/real_time_updater/manual-configuration).
...
Now we can Commit & Generate our changes, deploy, and try our [Fast Data](../../../docs/fast_data/overview) sending data from the Kafka Topic, and see the result in the Single View using the endpoints.
