...
The ultimate objective is to find the optimal values for **requests** and **limits** of a microservice by performing a load test, to know more about those values [check this out](/tutorial/request_limits.mdx).
