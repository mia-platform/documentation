...
:::info
Check out [this tutorial](../../tutorial/rest_api/quick_rest_api) and see this short [video](../../getting_started/video_pills/video_pills#how-to-create-a-crud) to learn how to create and expose CRUDs.
:::
