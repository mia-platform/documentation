...
* Use and configure a [Plugin](../).
* configure the [CMS](../../development_suite/api-console/api-design/api_console_configcms.md).

At the end of these steps, your services will run on Mia-Platform cloud.
...
4. Go to section [CRUD](../../api-console/api-design/crud_advanced.md) and click *Create new CRUD*.
...
Checkout the [endpoint documentation](../../api-console/api-design/endpoints.md) for more information about the section and to discover all the potentialities of this feature.
...
To try our CRUDs automatically exposed by an API, let's how access to [API Portal](../../api-portal/api-documentations.md) to try it and see the auto-generated API documentation.
...
!!! info
    You may already share the specs of your APIs with partners that are building the apps. You can export them to a JSON/Yaml file compliant with OpenAPI 3/Swagger format.  Check out the [API Portal documentation](../../api-portal/api-documentations.md) to further detail.
...
With Mia -Platform you can easily create and orchestrate your microservices. You can create a service from [examples](../../marketplace/examples/overview-examples.md) and [templates](../../marketplace/templates/overview-templates.md) or get one ready to use. There is a [whole set](../../runtime_suite/overview-runtime-suite.md) based on different use cases.  

!!! info
    For this walkthrough we'll use a ready-to-use service that we'll customize. You can find this in the [Marketplace](../../marketplace/overview-marketplace.md), with many other templates, example and ready-to-use services.
