...
In this guide, we will create a CRUD collection representing books and expose it via REST API. More specifically, we will:
...
:::info
If you have already done the [previous tutorial](/tutorial/api_portal/api_portal_tutorial.mdx), you can skip this section.
:::
...
After adding these fields, you can read the properties on the CRUD page, which will look like those shown below:
