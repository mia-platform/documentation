...
1. Have an [API Gateway](/runtime_suite/api-gateway/10_overview.md) or a [Envoy API Gateway](/runtime_suite_applications/envoy-api-gateway/overview.md) in your project;
