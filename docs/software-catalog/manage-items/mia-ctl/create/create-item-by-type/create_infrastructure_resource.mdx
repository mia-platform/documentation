...
To adding an infrastructure resource to you project you need to adding in the Markeplace using by [`miactl`](/cli/miactl/20_setup.md) o the [`Sofware Catalog`](/software-catalog/manage-items/software-catalog-ui/create/overview-software-catalog-create).
...
[CLI](/software-catalog/manage-items/mia-ctl/update/overview-mia-ctl-update) or the
[Software Catalog](/software-catalog/manage-items/software-catalog-ui/create/overview-software-catalog-create).
...
To update non-versioned infrastructure resource into the marketplace you can use the [CLI](/software-catalog/manage-items/mia-ctl/update/overview-mia-ctl-update).
...
The Object field is visualized as Editor
...
The Array field is visualized as Editor
...
The string type is used for textual input. It can include various validations such as minimum and maximum length.
...
The integer type is specifically for whole numbers. It behaves similarly to the number type but restricts input to integers.
...
The number type is used for numerical input, which can include both integers and floating-point numbers.
