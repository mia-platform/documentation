...
Mia-Platform Software Catalog track and store information about all the components that make up your infrastructure. You can view all the items by navigating to Software Catalog > All Items. Additionally, you can explore the item details.
