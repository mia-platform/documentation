...
To [create or edit](/software-catalog/items-management/overview.md) a plugin, you need to provide a [manifest](/software-catalog/manifests/overview.md), whose `resources` property should adhere to the following JSON schema.
