...
* [Ingestion topic](/fast_data/inputs_and_outputs#ingestion-message):  will be used by the Real-Time Updater
...
At this point, we have configured the microservice, we already have one system of records and two projections, but we need to expose the Projection endpoints. 
...
<details>
<summary>Example Reponses</summary>
<p>
