...
When entering our systems, the message is read by the [Kafka Message Adapter](/fast_data/configuration/realtime_updater/configuration_files.md#kafka-adapters-kafka-messages-format) of the Real-Time Updater, which uses it to update the Projections.
...
You can also specify a [custom adapter](/fast_data/configuration/realtime_updater/configuration_files.md#custom) to handle any other message formats you need.
