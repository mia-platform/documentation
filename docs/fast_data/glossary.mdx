...
<GlossaryTable entries={[
  ...
  {name: "Kafka adapter", description: "A function that transforms the ingested Kafka messages into a format that can be read by the the Real-Time Updater", alias: "-", link: "./configuration/realtime_updater/common#kafka-adapters-kafka-messages-format"},
  {name: "Golden Gate Adapter", description: "A Kafka adapter containing before and after fields", alias: "-", link: "./configuration/realtime_updater/common#golden-gate"},
  {name: "DB2 Adapter", description: "The default Kafka adapter", alias: "-", link: "./configuration/realtime_updater/common#ibm-infosphere-data-replication-for-db2"},
