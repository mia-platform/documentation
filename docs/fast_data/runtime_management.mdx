...
Runtime Management is a tool in the Fast Data environment for achieving better control over the Fast Data components during runtime.
...
:::note
Currently, this powerful mechanism is supported only in the Single View Creator, offering more than just the suspension of Single View generation on MongoDB.
:::
...
3. **Create a Kafka topic:** create a Kafka topic dedicated to receiving action commands.
  ...
  :::tip
  We suggest using a single-partitioned topic.
  :::
