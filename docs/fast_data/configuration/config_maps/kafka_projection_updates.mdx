...
The `__fromFile__` keyword lets you specify a Javascript module inside the squared brackets, which will execute the a manul Strategy on the Projection Updates message.
...
<details><summary>Simple Custom Strategy</summary>
<p>
...
<details><summary>Custom Strategy with 1:n lookup </summary>
<p>
