...
Starting from `v3.3.1`, the following fields can contain secrets that can be managed using the [Fast Data Secrets Resolution mechanism](/fast_data/secrets_resolution.md):
