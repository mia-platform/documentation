...
Starting from `v3.3.0`, the following fields contain secrets that can be managed using the [Fast Data Secrets Resolution mechanism](/fast_data/secrets_resolution.md):
