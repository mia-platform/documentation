...
If you select the Kafka Consumer, the service will create a Kafka Client to consume messages from the ingestion topics you setup in the _Projections_ section.
...
If you select the Kafka Consumer, the service will create a Kafka Client to produce messages into the topics related to the PR Updates you setup in the _Projections_ section.
