...
Then, you can scroll over the Control Plane section and write your JSON configuration.
...
The following fields contain secrets that can be managed using the [Fast Data Secrets Resolution mechanism](/fast_data/secrets_resolution.md):
