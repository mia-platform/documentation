...
to interact with the Control Plane will have all its artifacts (topics, projection or single views) in a `paused` state,
...
:::danger
If you're configuring Control Plane configurations for existing Fast Data workloads, they will be released in a 
