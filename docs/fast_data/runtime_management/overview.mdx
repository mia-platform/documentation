...
![Control Plane UI](img/runtime_management_initial_screen.png)
...
![Control Plane action command](img/runtime_management_request_with_parameters.png)
...
![Control Plane error log](img/runtime_management_error_log.png)
