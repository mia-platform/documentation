...
Among the services provided by both applications, there are the three services in charge of deploying the Fast Data Runtime Management solution, which are:
...
where an instance of Control Plane Operator has been deployed. In particular, a runtime can be identified across Fast Data Control Plane solution by these three parameters:
