...
:::tip
Control Plane frontend can also be embedded as an iFrame, to be used for example in the [Dashboards section of Mia-Platform Console](/development_suite/monitoring/dashboard.md#managing-dashboards).
...
one example is in case of an _Initial Load management process_. 
