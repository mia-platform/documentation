...
To make the endpoint work properly, you need to perform additional manual operations in the [Advanced Section](/development_suite/api-console/advanced-section/index.md) of your gateway.

This operations are needed to:
...
If you're using the standard Nginx API Gateway, you have to:
