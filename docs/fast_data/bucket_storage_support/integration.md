...
* Perform an [Initial Load procedure](/fast_data/data_loading.mdx#initial-load) of the System of Record, in order to align the messages written on the bucket with all the projections already stored
  on the database
...
* Perform an [Initial Load](/fast_data/data_loading.mdx#initial-load) procedure of the System of Record, in order to align the messages written on the bucket with all the projections already stored
on the database
