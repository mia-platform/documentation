...
The Payment Integration Hub application includes a [Flow Manager Service](/runtime-components/plugins/flow-manager-service/10_overview.md) in order to manage the **payment** life-cycle. 
...
The following schema is used in the collection, designed to be compatible with [payment gateway manager](/runtime-components/plugins/payment-gateway-manager/10_overview.md):
