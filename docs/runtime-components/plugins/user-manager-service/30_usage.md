...
[crud-indexes]: /products/console/api-console/api-design/crud_advanced.md#indexes
...
[configuration]: /runtime-components/plugins/user-manager-service/20_configuration.md
