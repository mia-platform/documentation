...
<Tabs queryString="type">
  ...
  Next, we must define the roles needed by the previously created service account. 
  ...
  Following these guidelines for configuring custom resources. 
  We need to make sure that the console has the correct permissions 
  ...
  After adding the necessary permissions follow this [guide](/console/design-your-projects/custom-resources/custom-resources.md) to see your custom resources inside the console
