...
sidebar_label: Orchestrator Generator wow
---
...
However, [in some scenarios](./use-cases.md), you may want to generate these files differently: in this case, you have to use an **Orchestrator Generator**.  
