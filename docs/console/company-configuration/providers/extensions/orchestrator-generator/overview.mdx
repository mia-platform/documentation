...
An Orchestrator Generator can only be used when the [Enhanced Project Workflow](/development_suite/set-up-infrastructure/overview.md) is enabled.
...
- check that the [Enhanced Project Workflow](/development_suite/set-up-infrastructure/overview.md) is enabled for the Project;
