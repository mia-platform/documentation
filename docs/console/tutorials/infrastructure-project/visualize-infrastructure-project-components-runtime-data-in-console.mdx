...
:::tip
To create such resources, we have created a set of Terraform modules that will help you prepare the cloud provider environment.

Ask your Mia-Platform referent to get access to it!
:::
