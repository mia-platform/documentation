...
![Create composer extension modal highligthing Infrastructure Component Runtime Catalog Table template](./img/visualize-infra-composer-extension-creation.png)