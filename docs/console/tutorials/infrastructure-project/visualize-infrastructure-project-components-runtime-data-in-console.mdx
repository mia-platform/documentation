...
:::tip
You can use an [Infrastructure Project](/console/project-configuration/infrastructure-project.md) to
provision these resources in your Cloud Provider, just like you would do with any other terraform module.
:::
