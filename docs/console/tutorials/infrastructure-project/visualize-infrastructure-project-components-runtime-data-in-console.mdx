...
to a format that complies with the [`infrastructure-component-runtime`](/software-catalog/manifests/infrastructure-component-runtime.md) item type in the Catalog.
...
using the [`infrastructure-component-runtime`](/software-catalog/manifests/infrastructure-component-runtime.md) item type

:::info
We are saving the items using the [`infrastructure-component-runtime`](/software-catalog/manifests/infrastructure-component-runtime.md) item type,
which is a specific item type used to store runtime data for infrastructure components.

You can find more information about this item type in the [Catalog documentation](/software-catalog/manifests/infrastructure-component-runtime.md).
:::
