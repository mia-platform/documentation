...
1. Click the _Applications_ menu item in the _Workloads_ section of the conosle left menu;
2. Click the button _Create new Application_;
3. Search the application _API Documentation Aggregator_ in the marketplace's right panel search bar;
4. Choose bewtwen the _NGINX_ or the _Envoy_ version;
