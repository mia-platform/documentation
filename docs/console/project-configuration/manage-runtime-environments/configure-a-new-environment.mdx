...
![add environment | secreted vars](/images/docs/console/add-environment-secreted-vars.png)
...
![add environment | public vars](/images/docs/console/add-environment-public-vars.png)
