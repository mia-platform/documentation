...
- **Company**: a company is a resource that has governance on all the projects it contains.
  ...
  To create a company, please refer to the [create company guide](/development_suite/company/create-company.md).
...
- **Template**: a template is a repository with pre-filled configurations. Each company can have one or more templates.
  ...
  In short, it constitutes a base from which your Project will be created. [Here](/development_suite/company/project-blueprint.md) you can find a guide on how to handle Project templates.
