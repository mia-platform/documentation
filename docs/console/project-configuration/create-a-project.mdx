...
- **Company**: a company is a resource that has governance on all the projects it contains.
  ...
  To create a company, please refer to the [create company guide](/console/company-configuration/create-company.md).
...
- **Template**: a template is a repository with pre-filled configurations. Each company can have one or more templates.
  ...
  In short, it constitutes a base from which your Project will be created. [Here](/console/company-configuration/project-blueprint.md) you can find a guide on how to handle Project templates.
...
1. **General**: in this phase, you will be asked to insert general information about your Project:
   ...
   * **Project workflow**: you can specify whether to use the [Enhanced Project Workflow](/development_suite/set-up-infrastructure/overview.md) or keep using the standard one.
