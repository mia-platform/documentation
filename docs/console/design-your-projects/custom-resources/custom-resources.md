...
:::info
To allow users to add a Infrastructure Resource to their project from marketplace, you need to apply it to your Company Software Catalog ([see here for details](/software-catalog/management/overview.md)).
:::
...
To learn more on how to add or manage a Infrastructure Resource in the Marketplace, see the [dedicated section](/software-catalog/management/overview.md) section.
