...
- **tenantId** (optional): the Company id, only needed if the component is a private, Company-owned, Marketplace component that must not be generally available on the Mia-Platform Marketplace.
