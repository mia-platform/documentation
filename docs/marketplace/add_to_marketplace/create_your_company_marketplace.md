...
::: info
If you have the *Marketplace Notfications* [feature preview](/console/project-configuration/project-settings.md#feature-preview) enabled you will be informed if one or more of your microservices attached to a Marketplace item have updates.
