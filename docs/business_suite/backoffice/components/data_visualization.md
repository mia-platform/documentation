...
`properties` field allows [dynamic interpolation](../core_concepts.md#dynamic-configuration), analogously to the case of mounting custom components using `visualizationOptions`, [explained above](data-visualization.md#dynamic-properties-interpolation).
