...
You will only need to configure the provider by selecting the respective credential type and the respective information to be able to use them as an authentication method fpor the provider.

For more information, visit the [documentation page](/console/company-configuration/providers/management.md#supported-credential-types).
