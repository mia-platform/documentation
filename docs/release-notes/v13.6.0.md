...
Starting from the release of v.13.6.0 of the Console, the following items will be marked as `Deprecated`. They will reach end-of-life in the upcoming release of v.14. Please take note of the changes.
