...
The applications _AI RAG Chat_ have been updated with a couple of minor fixes on the backend service:
...
- the API to generate embeddings from file now supports markdown files with exntension `.mdx`
