...
Console SaaS users will be granted direct access the v12 Preview and can open a Service Request asking for the creation of a sandbox Company to try out our latest features in Preview!
...
With Mia-Platform Console v12 it will be possiible to activate the Console-wide new look and feel experience for navigation of resources by activating the respective Feature Preview (which can be activated from the User panel).
