...
#### New Look and Feel in Feature Preview (Only for PaaS users)

Starting with this release it will be possiible to activate the Console-wide new look and feel experience for navigation of resources by activating the respective Feature Preview (which can be activated from the User panel).
...
#### Misconfiguration of Providers during Project creation
