...
:::info
Mia-Platform Console v12.0.0 is **now in Preview!**

Console SaaS users will be granted direct access to v12 Preview and can open a Service Request asking for the creation of a sandbox Company to try out our latest features in Preview!
...
To learn more about how to configure Azure Key Vault as a secret manager on Console, visit the dedicated documentation page.
...
To learn more about, check out the dedicated [documentation page](/runtime_suite/authentication-service/10_overview.md).
...
For self-hosted installations, please head to the [self hosted upgrade guide](/self_hosted/installation-chart/100_how_to_upgrade.md#v11---version-upgrades) or contact your Mia-Platform referent and upgrade to _Console Helm Chart_ `v11.0.0`.
