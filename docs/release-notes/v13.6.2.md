...
For more information about the clone functionality, refer to the [Microservice configuration documentation page](/development_suite/api-console/api-design/services.md#manage-microservices).
