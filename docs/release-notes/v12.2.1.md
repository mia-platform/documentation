...
For self-hosted installations, please head to the [self hosted upgrade guide](../infrastructure/self-hosted/how-to-upgrade.md#v12---version-upgrades) or contact your Mia-Platform referent and upgrade to _Console Helm Chart_ `v12.0.3`.
