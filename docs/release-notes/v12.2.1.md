...
Support for telepresence v2 has been added within the Debug area of the console. The commands that are displayed via the appropriate popup are now supported with the latest version of the tool.
