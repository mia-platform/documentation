...
This behavior has been introduced in the v12.0.0 of the console, and a fix to handle correctly empty values forof `pr-update` topic definitions has been included in the v12.0.3 of the console. 
