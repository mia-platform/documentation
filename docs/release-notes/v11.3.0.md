...
For more information, [go to the documentation](/business_suite/backoffice-configuration/30_compose_pages.md#shared-properties)
...
New component [bk-file-picker-modal](/business_suite/back-kit/60_components/40_data_manipulation.md#bk-file-picker-modal) is available, analogous to `bk-file-picker-drawer`.
