...
To know more about how to configure Mongezium CDC, visit the [official documentation](/products/fast_data/fast_data_engine_v2/mongezium_cdc/10_Overview.md).
