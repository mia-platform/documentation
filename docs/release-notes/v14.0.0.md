...
With v14, the **Software Catalog** gets a powerful upgrade. We’ve refined how items are managed and introduced clearer, standardized schemas — fully documented and easily accessible for all through our [official documentation](/software-catalog/overview).
...
We recommend updating any existing integrations to align with the [latest APIs](/software-catalog/items-management/api) to ensure long-term compatibility and support.
