...
* fixed bug in project creation that prevented the user from finding the default template set by Blueprint;
* fixed bug that caused a problem with redirects in Runtime section;
