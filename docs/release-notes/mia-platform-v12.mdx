...
To learn more about all the advantages offered by this feature, take a look at the video below or read the [official documentation](/development_suite/set-up-infrastructure/enhanced-project-workflow).
