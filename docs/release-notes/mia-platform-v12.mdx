...
Thanks to [miactl (Mia-Platform CLI)](/cli/miactl/overview.md), you can manage the items of your Internal Company Marketplace without the need to use the CMS!
