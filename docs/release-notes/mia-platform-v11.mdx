...
The Runtime Area has been enriched by adding several new k8s resources: after the introduction of Pods and Namespaces, we are now welcoming also Deployments, Services, Cronjobs, and Jobs sections!  
...
With these new connectors, you can seamlessly integrate your data from a wide variety of sources, including databases, bucket storages and more, leveraging on Debezium CDC and other hand-made connectors.
...
At the heart of Mia-Platform Fast Data product there is a commitment to help our customers unlock the full potential of their data. With these new plug-and-play connectors, we are proud to take another step towards achieving this goal, and we look forward to seeing the many ways our customers will use them to drive their businesses forward.
