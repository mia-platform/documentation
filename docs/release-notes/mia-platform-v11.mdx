...
Through the new dedicated section - named "Providers" - inside the "Company Overview" area it will be possible to manage the creation, configuration, and editing of the providers used by Mia-Platform Console (Git Provider, Secret Manager and CI/CD Tools).
...
### Machine-to-Machine Aut/docs/development_suite/set-up-infrastructure/providers-managementhentication
...
For more information, [go to the documentation](/development_suite/identity-and-access-management/service-account-management.md).
...
The Runtime Area has been enriched by adding several new k8s resources: after the introduction of Pods and Namespaces, we are now welcoming also the Deployments, Services, Cronjobs, and Jobs sections!  
...
In the Design Overview section – accessible from the Company Overview – you can now get a brief overview of your Company, by accessing a rich set of visualization tools that can help you aggregate resources from all Projects across your Company into a single table.
...
For now, the CLI will only be available for PaaS users, but more good news will come soon.
...
With just a few clicks, you can quickly and easily set up connections to your data sources, and start managing your data in a way that makes sense for your business.

At the heart of Mia-Platform Fast Data product is a commitment to help our customers unlock the full potential of their data. With these new plug-and-play connectors, we are proud to take another step towards achieving this goal, and we look forward to seeing the many ways our customers will use them to drive their businesses forward.
...
Users can now easily store their data to a cloud storage bucket (Google and S3-like buckets are supported) and can be sure that their data is securely stored and easily accessible whenever they need it. This new feature also makes it easy to restore data whenever is needed.  
...
One of our mission is to simplify the Development Experience, and the Backoffice Low Code / No Code Configurator goes towards this direction. 
...
With this new feature, users can now quickly and easily customize the look and feel of their Backoffice pages without the need for technical skills or coding knowledge.  
