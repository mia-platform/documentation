...
For more information, go to the [documentation](/) and visit [Mia-Platform Console v14 Overview](/release-notes/mia-platform-v14.mdx#projects-for-infrastructure-provisioning).
...
For more information, go to the [documentation](docs/console/console-extensibility/sso.md) and visit [Mia-Platform Console v14 Overview](/release-notes/mia-platform-v14.mdx#iframe-extensions-support-login-with-console-sso).
