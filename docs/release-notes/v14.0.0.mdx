...
We recommend updating any existing integrations to align with the [latest APIs](/software-catalog/management/api.md) to ensure long-term compatibility and support.
