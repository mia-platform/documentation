...
For a complete overview of the new layout and its features, see the [Flow Manager Configurator documentation](/products/console/api-console/api-design/flow-manager-configurator/overview.md).
...
When using [**Fast Data Control Plane**](/products/fast_data/runtime_management/overview.mdx), aggregation processes configured in Fast Data Projects can be automatically captured, making Fast Data jobs visible on the Lineage canvas.

To find out how it works and all the benefits of our Data Lineage solution, please refer to the related [documentation](/products/data_catalog/frontend/data_lineage.mdx).
...
To learn more about all the features and how to configure it, visit the [official documentation](/runtime-components/plugins/integration-connector-agent/10_overview.md).
...
To learn more about how to configure it, visit the [official documentation](/products/data_catalog/frontend/data_catalog_connections.mdx#mongodb).
...
To explore all the new features and learn how to manage Software Catalog items, visit the [official documentation](/products/software-catalog/overview.md).
...
To discover more, head to the related [documentation](/products/console/set-up-infrastructure/env-based-management.md).
...
To discover more, head to the related [documentation](/products/console/identity-and-access-management/monitor-audit-logs.md).
...
To discover more, head to the related [documentation](/products/console/project-configuration/infrastructure-project.md).
