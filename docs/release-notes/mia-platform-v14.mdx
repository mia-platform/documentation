...
Users will work directly within specific environments across all Mia-Platform Console sections, establishing a consistent and intuitive experience and aligning the Design area with the logical structure of other areas.

### Projects for Infrastructure Provisioning  

We have introduced a new category of Projects within Mia-platform Console designed to streamline infrastructure management for Operations teams.  
These Projects are specialized for provisioning and managing infrastructure resources directly through the Console interface.  
Teams can now easily visualize and control the state of their infrastructure and execute necessary provisioning actions, enabling more efficient and tailored workflows for infrastructure-related tasks. 
