...
### Manage extensions from Console UI | <Highlight color="#1890FF">v13 - Fall Release</Highlight>

We are keeping our ecosystem growing by continuously adding new capabilities to the Platforge Extensibility Kit. Extend your Console by embedding iFrames, adding External Links & composing your pages with Microfrontend Composer using a dedicated "Extensions" manager, accessible to Company Owners within the Platforge section at the Company level.

Start customizing your Console by adding your first iFrame extension: simply select the desired Area and Sidebar section from the options, then input the URL you want to display to your users!
...
### Support to all infrastructure Resources in Console | <Highlight color="#1890FF">v13 - Fall Release</Highlight>
...
### Support of Custom Resources in the Runtime area
