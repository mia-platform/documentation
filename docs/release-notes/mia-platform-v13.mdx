...
Through the dedicated section within the Design area, it is now possible to manage and configure Custom Resources on Kubernetes using its classic user interface.

This feature further expands the Console's domain over the user's entire workload, enabling greater operability, governance, and control over systems.
