...
### Manage extensions from Console UI (fall release)
...
### Support to all infrastructure Resources in Console (fall release)
...
### Versioning management for Marketplace resources (fall release)
