...
- **[Initial Load and Full Refresh processes management](/fast_data/data_loading.mdx)**, thanks to a user-friendly interface and without altering the configuration of your workloads deployed in runtime 
