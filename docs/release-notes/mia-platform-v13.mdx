...
You can now manage and configure Custom Resources on Kubernetes using the classic user interface of the Console. This feature further expands the Console's domain over the user's entire workloads, enabling greater operability, governance, and control over systems.
