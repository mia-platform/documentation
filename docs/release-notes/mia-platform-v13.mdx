...
From now on, you can seamlessly integrate external web pages within the Mia-Platform Console using iFrames. 
...
INSERT AN IMAGE -> mettiamo immagine della sidebar con scritto my extension??????
...
INSERT AN IMAGE -> mettiamo la history dei webhook!
...
On Backstage Marketplace you will find the Mia-Platform plugin for integrating Mia-Platform components into Backstage components.  
