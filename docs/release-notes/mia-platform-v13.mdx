...
With this Fall release we have officially introduced the possibility to manage the provisioning of your infrastructure, configuring - at the Design level - your Infrastructure Resources.  
...
To discover more, please refer to the [documentation page](/console/design-your-projects/custom-resources.md) and check out some useful [use cases](/console/design-your-projects/custom-resources/custom-resources-use-cases.md).

### Support of Kubernetes Resources in Runtime area | <Highlight color="#1890FF">v13 - Fall Release</Highlight>

We finalised the support for Kubernetes type Resources by introducing the possibility of monitoring such resources at Runtime once deployed.  
...
### Manage custom Resources through Console
...
### Versioning management for Marketplace resources | <Highlight color="#1890FF">v13 - Fall Release</Highlight>

versioning for Marketplace resources is now available in Mia-Platform Console, allowing users to view, select, and manage different versions of Plugins and infrastructure Resources. Users can choose the version that best fits their needs and easily switch between versions.  
