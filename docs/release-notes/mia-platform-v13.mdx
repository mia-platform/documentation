...
In this release, we have worked on an application to extend the use of AI assistance with the process of Retrieved Augmented Generation (RAG) in a simple way. You can then configure a RAG Application chat within your project to easily set up your own chatbot. This application is featuring automatic embeddings generation from website pages.  
