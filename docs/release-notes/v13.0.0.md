...
Inside a brand new dedicated section within the Design area, it is now possible to manage and configure Kubernetes Custom Resources managed by the cluster.
