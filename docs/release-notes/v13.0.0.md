...
* Single Views and CRUD collections can now be used as [Base Projection](/fast_data/concepts/glossary.mdxx#fast-data-terms) options inside the Aggregation placeholder or the Single View Creator `Settings` tab
