...
![Fast Data Control Plane Frontend](img/fd-domain-pipeline.gif)
...
Refer to back-kit [changelog](https://docs.mia-platform.eu/docs/microfrontend-composer/back-kit/changelog) for finer-grained details of new versions.
