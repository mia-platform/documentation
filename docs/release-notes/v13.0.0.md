...
:::caution
This version contains a bug in the Flow Manager Configurator that prevents saving when moving from lower Console versions if the Flow Manager design section is not opened. This bag has been solved in `v13.0.1`. For on-premise installations we recommend not to use this version. Please check the `v13.0.1` Release notes [here](/release-notes/v13.0.1.md).
:::
...
Find more information at the related [documentation page](/development_suite/company/create-company.md).
