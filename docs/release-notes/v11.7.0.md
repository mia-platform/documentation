...
:::caution
This version contains a bug in the Fast Data configurator, that has been solved in `v11.7.1`. For on-premise installations we recommend not to use this version.
:::
