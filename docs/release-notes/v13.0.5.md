...
The Design Overview section, available at Company level, is now visible also to users with a Guest role. 
...
* We fixed a misconfiguration that prevented the correct refresh of pages with
