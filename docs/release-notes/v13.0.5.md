...
For further details, please refer to the [documentation](/microfrontend-composer/composer/structure.md#translations).
...
Try it out and see the [documentation](/microfrontend-composer/composer/structure.md#components-explorer) for more details.
...
* API Portal version `2.0.1` is now [served directly](/runtime_suite/swagger-aggregator/apis.md#static-route) from Swagger Aggregator version `3.7.0`
