...
Start customizing your Console by adding your first iFrame extension by simply selecting the Area and Sidebar section from the available options and adding the entry URL you want to make visible to your users! 
