...
It hab been fixed a bug in the project creation that caused a malfunction of the default CI/CD tool display of each environment.

#### "Undefined" in the detail of a pod error

It hab been fixed a bug that did not allow the user to understand the type of error running in a pod, showing a generic "undefined" in the information popup.
