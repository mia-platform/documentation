...
More specifically, Company Owners and Project Administrators can now be able to manage Marketplace resources that will be available exclusively for the members of their Company. 

To discover more information on how to manage Marketplace resources owned exclusively by the Company, visit the dedicated Marketplace [documentation page](/marketplace/add_to_marketplace/contributing_overview.md#public-and-private-marketplace).
...
For on-premise Console installations, please contact your Mia-Platform referent to know how to use the `Helm chart version 9.1.4`.
