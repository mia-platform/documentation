...
You can now modify the Service account name for your Microservices directly from the new "Service account" card, available in the Microservice detail page, giving you more flexibility and better access control on your workload.
