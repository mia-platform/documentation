...
If you want to discover more about the potentiality of Marketplace resource versioning and how it works, head to the [dedicated section](/old_software-catalog/manage-items/overview.md#set-controlled-versions-for-your-marketplace-resources-and-make-them-available-to-users) inside the [Company Marketplace](/old_software-catalog/manage-items/overview.md) documentation page.

Visit also the [Plugins](/old_software-catalog/manage-items/mia-ctl/create/create-item-by-type/create_plugin.md) and [Custom Resources](/old_software-catalog/manage-items/mia-ctl/create/create-item-by-type/create_infrastructure_resource.mdx) documentations for more information about how to correctly create and manage them.
