...
Now, after you have resolved all the diffs inside a specific section inside of the Merge modal, you see a visual indicator in the form of a green checkmark next to each section, indicating that all the diffs within that section have been resolved.
