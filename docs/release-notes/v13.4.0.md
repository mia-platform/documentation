...
Check the [Audit Trail sidecar documentation](/runtime_suite/audit-trail/overview.md) for additional information about architecture, configuration and usage.
