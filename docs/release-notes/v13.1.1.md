...
#### Writable views endpoints full CRUD routes support
...
Our `AI RAG Chat` Application has been released in its stable version, now featuring automatic embeddings generation from website pages.
