...
More details on this feature can be found in the dedicated [section](/runtime_suite/crud-service/overview_and_usage.md#import) of the Overview and Usage documentation page.
