...
Internal navigation to other sections of the Console now works correctly even if the dynamic parts of the URL contain
some characters that need escaping (e.g., `/`).
