...
:::info
The cluster the Mia-Platform Console is installed on strictly depends on your Mia-Platform license ([PaaS](/requirements/paas/overview.md), [BYOI](/requirements/byoi/overview.md) or [Self hosted](/requirements/self-hosted/self-hosted-requirements.md)).
