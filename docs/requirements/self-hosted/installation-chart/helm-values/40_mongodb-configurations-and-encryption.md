...
As mentioned in the [General Settings page](/requirements/self-hosted/installation-chart/helm-values/20_general-settings.md), to connect with MongoDB, Mia-Platform Console only needs the connection string provided using the `configurations.mongodbUrl` configuration.
