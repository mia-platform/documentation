...
To know more about user synchronization with an Identity Provider, visit the [dedicated documentation page](/requirements/self-hosted/installation-chart/helm-values/26_synchronize-users-with-an-identity-provider.md).
