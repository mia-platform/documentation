...
<<<<<<< HEAD:docs/microfrontend-composer/back-kit/60_components/490_search_bar.md
[img-bk-search-bar]: img/bk-search-bar.png
=======

>>>>>>> main:docs/business_suite/backoffice/60_components/490_search_bar.md
...
if the user enters text "example" in the Search Bar, a `change-query` event is emitted with payload:
