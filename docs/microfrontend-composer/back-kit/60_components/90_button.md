...
The following configuration renders a Button component which, on click, notifies the need to visualize the details of the corresponding row.
...
first sends an GET request to "/orders-count" and then, once a response is received, emits a [create-data][create-data] event.
