...
- `scope`: a target set of items defined as a [view](/products/context-catalog/usage/catalog-app.md#views) reference or a raw query (see [Query Language](/products/context-catalog/basic-concepts/70_query-language.md)).
...
- [Catalog App](/products/context-catalog/usage/catalog-app.md): where to monitor campaign progress in the UI.
