...
1. Be integrated with a [deploy pipeline](/requirements/self-hosted/pipeline-configuration.md);
1. Have an [ingress route](/requirements/paas/tools/traefik.md) with `api-gateway` as `service`;
