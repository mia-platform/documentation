...
:::info
When Rönd is enabled on your microservice the `rbac-service` sidecar is added to the microservice. This is a [special sidecar](/products/console/api-console/api-design/microservice-containers.md#special-sidecars) managed by the Authorization section.  
You can then find it listed in the [Sidecars section](/products/console/design-your-projects/sidecars.md) as well as in the [microservice containers table](/products/console/api-console/api-design/microservice-containers.md).
:::
