...
To set up filters in Envoy, refer to [`on-request-scripts.yaml`](https://docs.mia-platform.eu/docs/products/console/api-console/advanced-section/api-gateway-envoy/extensions#lua-scripts)
and [`http-filters.yaml`](https://docs.mia-platform.eu/docs/products/console/api-console/advanced-section/api-gateway-envoy/extensions#http-filters)
