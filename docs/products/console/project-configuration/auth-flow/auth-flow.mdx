...
The [Authorization Flow](authorization-flow.md) shipped with the Console relies on a chain of
...
- [Configuration](configuration.mdx) — Envoy API Gateway and BFF setup
- [Frontend Application](frontend-application.mdx) — JavaScript client library and React integration
