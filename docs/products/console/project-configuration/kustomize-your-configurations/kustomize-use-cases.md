...
:::info
You can apply labels to microservices inside the Design section of the Mia-Platform Console, or, in case of Self-Hosted installation, you can [set default labels](/products/console/software-catalog/items-manifest/plugin.md) to the microservices created from Marketplace.
:::
