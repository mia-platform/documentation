...
The value set for such port can be find the in the "Port" column of [Container ports](/products/console/api-console/api-design/microservice-container-ports.md) section of the microservice detail .
...
:::info
Here you can find an introduction about [environment variables](/products/console/project-configuration/manage-environment-variables/index.md).
:::
