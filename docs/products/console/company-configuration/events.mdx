...
This event will be triggered when [a Version is successfully deleted](/development_suite/set-up-infrastructure/revisions-and-versions.md#versions-section).
