...
```sh
go install github.com/mia-platform/miactl/cmd/miactl@v0.21.0
```
...
```sh
curl -fsSL --proto '=https' --tlsv1.2 https://github.com/mia-platform/miactl/releases/download/v0.21.0/miactl-linux-amd64 -o /tmp/miactl
```

```sh
wget -q --https-only --secure-protocol=TLSv1_2 https://github.com/mia-platform/miactl/releases/download/v0.21.0/miactl-linux-amd64 -O /tmp/miactl
```
...
```sh
docker run ghcr.io/mia-platform/miactl:v0.21.0 miactl
```
...
[url]: https://github.com/mia-platform/miactl/releases/download/v0.21.0/checksums.txt "miactl checksums"
