...
Fast Data solution can either be installed in a [PaaS](/requirements/paas/overview.md) or [Self-Hosted](/requirements/self-hosted/self-hosted-requirements.md) setup. The goal of this guide is to provide best practices that are independent of the infrastructure.
