...
![Assets pulled with their related Business Glossary terms](../img/excel_pull_assets_related_terms.png)
...
Click the **Select Terms** button to open a panel listing the terms defined in the glossary, searchable by name; each entry also shows its Term Type. Select one or more terms and click **Pull terms** to import them into the worksheet.
...
- `Term type` - the term's [Term Type](/products/data_catalog/frontend/data_catalog_business_glossary.mdx#create-a-term)
...
![Push metadata column selection for terms](../img/excel_push_terms_column_selection.png)
