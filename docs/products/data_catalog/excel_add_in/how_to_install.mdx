...
![Data Catalog Excel plugin](../img/data-catalog-excel-plugin.png)
...
- Data Catalog Frontend: `v0.4.0`
- Open Lineage: `v0.4.0`

For more information, refer to the [Data Catalog Compatibility Matrix](/products/data_catalog/compatibility_matrix.md).
:::
...
- `/excel` pointing to the Excel Add-in service, exposed on the Container Port `http 80:8080`; once created, go to Advanced tab of the endpoint detail page, and inside the `Iframe embedding options`, select `Any origin`.
