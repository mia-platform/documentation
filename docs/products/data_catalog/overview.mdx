...
* **Business Glossary**: Provides a shared, business-friendly vocabulary made of Terms, that can be related to one another and associated to data assets, helping users discover and understand data using familiar business language rather than technical jargon.
...
- visit the dedicated [documentation page](/products/data_catalog/frontend/data_catalog_business_glossary.mdx) to discover the Business Glossary feature;
