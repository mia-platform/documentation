...
Data Catalog frontend communicates with [Open Lineage](/products/data_catalog/data_catalog_open_lineage.mdx) backend
via [Fabric BFF](/products/data_catalog/data_catalog_fabric_bff.mdx) component.
...
* an [Asset Discovery section](/products/data_catalog/frontend/data_catalog_assets.mdx)  that allows users to navigate data assets and to perform a series of actions useful for data governance and metadata enrichment;
* a [Business Glossary section](/products/data_catalog/frontend/data_catalog_business_glossary.mdx) that allows users to define a shared business vocabulary and to link it to data assets;
* a [Data Lineage section](/products/data_catalog/frontend/data_lineage.mdx) that allows users to understand, visualize, and describe the flow and transformations of data within an organization;
* a [Connections section](/products/data_catalog/frontend/data_catalog_connections.mdx) that allows users to manage the connections used to retrieve assets.
...
Bear in mind that changing the `BASE_PATH` environment variable requires to change also the [rewrite base path](/products/console/api-console/api-design/endpoints.md#about-rewrite-base-path)
...
This can be configured in the `Endpoints` page of Console Design area, as explained [here](/products/console/api-console/api-design/endpoints.md).
...
For more details on the websocket endpoint, please read the [endpoint paragraph](/products/data_catalog/data_catalog_open_lineage.mdx#endpoints) of Open Lineage service documentation.
...
under a [different listener](/products/console/api-console/api-design/listeners.md), remember to update the configuration accordingly.
:::
...
Data Catalog UI can be embedded as an extension of Mia-Platform Console using [Mia-Platform Platforge Extensions](/products/console/console-extensibility/overview.md).
...
In order to achieve so, Mia-Platform Console offers an integrated tool for [managing extensions](/products/console/company-configuration/extensions.md)
