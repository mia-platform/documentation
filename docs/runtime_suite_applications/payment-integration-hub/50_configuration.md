...
The user could perform the additional steps reported below in order to create mongo views that enabled to use the ready to use [backoffice pages related to payments](./40_backoffice_payment.md).
...
4. Create endpoint for the mongoDB view previously created `subscriptions_view`
  ...
  - Choose mongoDB view as type
  - Choose Mongo view base path as `/subscriptions-view`
...
6. Create endpoint for the mongoDB view previously created `adaptive-checkout-view`
  ...
  - Choose mongoDB view as type
  - Choose Mongo view base path as `/adaptive-checkout-view`
