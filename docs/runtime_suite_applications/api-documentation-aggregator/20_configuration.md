...
The **API Documentation Aggregator** application can be added to your project by visiting Mia-Platform [Applications](https://docs.mia-platform.eu/docs/marketplace/applications/mia_applications). To configure it properly, there are essentially 2 ways.
...
:::tip
You can set up a login process by using the [Auth0 Client](https://docs.mia-platform.eu/docs/runtime_suite/auth0-client/overview) plugin, that you can find in the [Marketplace](https://docs.mia-platform.eu/docs/marketplace/overview_marketplace).
:::
...
4. [Create three new endpoints](https://docs.mia-platform.eu/docs/development_suite/api-console/api-design/endpoints) with the following configurations:
    - Endpoint 1:
