...
to the `bk-layout` component inside of `layout` following the [official documentation](http://localhost:3000/docs/business_suite/back-kit/components/misc#user-menu).
