...
Check out the dedicated [section](/getting-started/tutorials/requests-limits/requests-limits-tutorial.mdx) for more information regarding requests and limits.
:::
