...
The secret needs to be created through one of the [supported environments variable provider](/development_suite/set-up-infrastructure/env-var-intro.md).
...
At this step you only need to [deploy](/development_suite/deploy/overview.md#introduction) and you will have the basic auth at the basepath `my-hostname.eu`.
