...
The secret needs to be created in the [Environments Variable section](/development_suite/set-up-infrastructure/runtime-environments.md#add-an-environment).
