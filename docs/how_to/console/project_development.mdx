...
The value set for such port can be find the in the "Port" column of [Container ports](/development_suite/api-console/api-design/microservice-container-ports.md) section of the micorservice detail .
