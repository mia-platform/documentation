...
<details><summary>click here to see the full json file</summary>
<p>
...
For the full list and description of the available operations please see [here](/runtime_suite/crud-service/overview_and_usage.md#crud-endpoints).
...
The Mia Platform Console lets you use the CRUD Service OSS as a [plugin](/runtime_suite/crud-service/overview_and_usage.md) from the [Marketplace](/marketplace/overview_marketplace.md).

![CRUD Service Plugin](img/crud-service-plugin.png)

The plugin is fully integrated and ready out of the box. You simply need to create your [MongoDB CRUD](/development_suite/api-console/api-design/crud_advanced.md) and deploy without any further configurations. The plugin is also integrated with the [Documentation Portal](/development_suite/api-portal/api-documentations.md), with the advantage that you have in one place the APIs of all your services and CRUDs.

You can see a usage example of the plugin in this [tutorial](/tutorial/rest_api/quick_rest_api.md).