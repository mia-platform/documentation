...
New features have been introduced in order to manage sensible data and their protection inside Mia-Platform's Console.
With the new [Sensitivity](../development_suite/api-console/api-design/gdpr#sensitivity) functionality, you can now classify data in many different ways, organizing information into fixed categories with specific attributes. Data classification can help you stay compliant with the GDPR by allowing you to properly organize your data and implement security controls to detect anomalies.
