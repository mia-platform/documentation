...
Mia-Platform v8 supports Multi-Git Providers, embracing a more convenient login and accessing all the tools connected to Mia-Platform Console with a single click.
...
The new Mia-Platform Headless CMS, is much easier to maintain, test and scale with a new micro frontend architecture that allows greater flexibility.
