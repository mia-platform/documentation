...
Mia-Platform v7.0 offers multiple solutions to support Security and Compliance Operations management. Your systems will be equipped with different levels of security and permissions thanks to numerous microservices that interact with authentication providers such as [Auth0 Client](../runtime_suite/auth0-client/usage) and **Authentication Service**. Moreover, to improve the security of your applications, we have designed the new [Client Credentials service](../runtime_suite/client-credentials/configuration) which enables permissions and authorizations management for your clients with different security levels.
