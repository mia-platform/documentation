...
This connector manages connection, authentication, and processing of data received via Salesforce streaming API. It listens to the changes of the data sources of Salesforce, and bring them on one or more Kafka topics.
