...
The service will consume Kafka messages produced by the RTU on a specific topic, will execute the appropriate strategies, and will generate projection changes either on MongoDB or Kafka.
