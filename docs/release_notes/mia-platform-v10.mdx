...
In fact, it is possible to connect and manage Kubernetes Clusters through an easy-to-use interface and view some details about it, regardless of the Vendor and Kubernetes distribution installed. Find out more [here](../development_suite/clusters-management).
