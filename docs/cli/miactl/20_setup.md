...
```sh
go install github.com/mia-platform/miactl/cmd/miactl@v0.12.1
```

Or like this if the `install` command is not available

```sh
go get -u github.com/mia-platform/miactl/cmd/miactl@0.12.1
```
...
```sh
curl -fsSL https://github.com/mia-platform/miactl/releases/download/v0.12.1/miactl-linux-amd64 -o /tmp/miactl
```

```sh
wget -q https://github.com/mia-platform/miactl/releases/download/v0.12.1/miactl-linux-amd64 -O /tmp/miactl
```
...
[url]: https://github.com/mia-platform/miactl/releases/download/v0.12.1/checksums.txt "miactl checksums"
