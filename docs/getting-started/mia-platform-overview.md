...
- [Mia-Platform Backoffice](/business_suite/backoffice/what-is-backoffice.md): create custom CMSs, or generic User Interfaces, with the ability to compose custom pages, putting whatever web component coming from the back-kit library or from a custom component library.
