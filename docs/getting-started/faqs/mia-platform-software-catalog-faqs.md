...
[Discover more](/products/console/software-catalog/overview.md)
...
* **Infrastructure Component runtime**: Pre-packaged infrastructure components.
  [Discover more](/products/console/software-catalog/items-manifest/overview.md)
...
[Discover more](/products/console/software-catalog/items-management/ui.md#versions)
...
[Discover more](/products/console/software-catalog/items-management/overview.md)
...
* [Software Catalog UI](/products/console/software-catalog/items-management/ui.md): a user-friendly graphical interface within the Console, ideal for manual and quick operations,
* [miactl](/products/console/software-catalog/items-management/miactl.md), the official Mia-Platform command-line tool. Perfect for automation, scripting, and advanced workflows,
...
* [API Access](/products/console/software-catalog/items-management/api.md): you can interact directly with the underlying APIs to perform programmatic changes.
...
[Discover more](/products/console/software-catalog/items-manifest/overview.md) or use the specific pages in this section to learn how the resources field should be formatted for each item type.
...
[Discover more](/products/console/software-catalog/items-management/miactl.md#declarative-approach)
...
[Discover more](/products/console/software-catalog/items-management/miactl.md)
...
[Discover more](/products/console/software-catalog/basic-concepts/20_items-versioning.md) 

#### How do I delete an item from the catalog?
You can delete an item from its detail page in the [Software Catalog UI](/products/console/software-catalog/items-management/ui.md#delete-item), with [miactl](/products/console/software-catalog/items-management/miactl.md) or [API access](/products/console/software-catalog/items-management/api.md). This action requires high-level permissions. Note that deleting an item from the catalog does not affect any projects that are already using it.
...
[Discover more](/products/console/software-catalog/items-manifest/application.md)
...
[Discover more](/products/console/software-catalog/items-manifest/template.md#private-repositories)
...
[Discover more](/products/console/software-catalog/items-management/api.md)
...
[Discover more](/products/console/software-catalog/items-manifest/plugin.md)
...
[Discover more](/products/console/software-catalog/basic-concepts/30_items-lifecycle.md)
