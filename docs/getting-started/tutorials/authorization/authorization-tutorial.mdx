...
If you don't have it yet, you can easily set it up following the [Create a Rest API in 5 minutes](/getting-started/tutorials/rest-api/quick-rest-api.mdx) guide
