...
:::info
If you have already done the [previous tutorial](/getting-started/tutorials/microservices/hello-world.mdx), you can skip the rest of the section and directly start the tutorial.
:::
...
1. Save the changes. You don't know how to do it? Take a look at [Mia-Platform handbook](/getting-started/tutorials/console/console-handbook.md#save-changes)!
...
:::tip
You can import fields during the creation phase of a new CRUD Collection, by clicking on the "Import fields from file" button, as you can see in the [image](/getting-started/tutorials/rest-api/quick-rest-api.mdx#create-a-new-crud-collection).
:::
...
:::tip
If you don't know how to do it take a look at the [first tutorial](/getting-started/tutorials/microservices/hello-world.mdx#expose-the-hello-world-microservice-api)
:::
...
Our configuration is ready. You can **save** and **deploy** it in a runtime environment! You don't know how to do it? Take a look at [Mia-Platform handbook](/getting-started/tutorials/console/console-handbook.md#deploy-changes)!
