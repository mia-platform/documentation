...
:::info
If you have already done the [previous tutorial](/getting-started/tutorials/microservice-hello-world.mdx), you can skip the rest of the section and directly start the tutorial.
:::
...
1. Save the changes. You don't know how to do it? Take a look at [Mia-Platform handbook](/getting-started/tutorials/project-usage-handbook.md#save-changes)!
...
:::tip
If you don't know how to do it take a look at the [first tutorial](/getting-started/tutorials/microservice-hello-world.mdx#expose-the-hello-world-microservice-api)
:::
...
Our configuration is ready. You can **save** and **deploy** it in a runtime environment! You don't know how to do it? Take a look at [Mia-Platform handbook](/getting-started/tutorials/project-usage-handbook.md#deploy-changes)!
