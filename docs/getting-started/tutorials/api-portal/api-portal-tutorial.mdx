...
:::info
If you have already done the [previous tutorial](/getting-started/tutorials/microservices/hello-world.mdx), you can skip this section and go on using the same project.
:::
...
1. Save the changes by committing. If you do not know how to do it, take a quick look at [Mia-Platform handbook](/getting-started/tutorials/console/console-handbook.md#save-changes) first.
...
:::tip
If you don't know how to create an endpoint look at the [first tutorial](/getting-started/tutorials/microservices/hello-world.mdx#expose-the-hello-world-microservice-api)!
:::
...
:::tip
If you do not know how to do it, take a quick look at [Mia-Platform handbook](/getting-started/tutorials/console/console-handbook.md#deploy-changes).
:::
