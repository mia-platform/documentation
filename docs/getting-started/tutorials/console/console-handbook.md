...
For more information about monitoring CPU and memory using Grafana please see the _Set Requests and Limits of a Microservice_ [tutorial](/getting-started/tutorials/requests-limits/requests-limits-tutorial.mdx#monitoring-cpu-and-memory-usage).
