...
Before starting, you should be familiar with the [Mia-Platform Backoffice](/business_suite/backoffice/what-is-backoffice.md) concepts and have the following:
