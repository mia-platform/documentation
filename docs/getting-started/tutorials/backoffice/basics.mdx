...
With all the configurations in place, save your changes and then deploy. For further details on the deploy command, consult the [Console Handbook](/getting-started/tutorials/project-usage-handbook.md).
