...
- A CRUD microservice already created, follow the [CRUD Tutorial](/getting-started/tutorials/rest-api/quick-rest-api.mdx) if needed.
...
:::warning
If you're unfamiliar with CRUD microservices, consider consulting the [CRUD Tutorial](/getting-started/tutorials/rest-api/quick-rest-api.mdx).
:::
...
With all the configurations in place, save your changes and then deploy. For further details on the deploy command, consult the [Console Handbook](/getting-started/tutorials/console/console-handbook.md).
