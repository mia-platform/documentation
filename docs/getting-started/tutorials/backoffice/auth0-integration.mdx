...
* [Secure API Gateway](/runtime_suite_applications/secure-apigateway/overview.md)

and some of the concepts described on this tutorial:
* [Dev Portal - Authentication Configuration](/runtime_suite_applications/dev_portal/authentication_configuration.md)

## Setup the Microservices

You can install almost all the microservices for this tutorial using the [Secure API Gateway](/runtime_suite_applications/secure-apigateway/overview.md) application:
...
In order to configure the `auth0-client`, the first step require to setup the **Auth0 Tenant**. You can follow this page: [Configure Auth0](/runtime_suite/auth0-client/30_configure_auth0.md) (for the scope of this tutorial you can avoid steps 3 and 4).

When the tenant configuration is completed you should have created:
...
In our case, the client type will be **frontEnd**. The final configuration will look something like this: 
