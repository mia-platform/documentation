...
Before starting this tutorial, we need to be familiar with the concepts of the [Mia-Platform Microfrontend Composer](/microfrontend-composer/what-is.md) and have completed:
* The [Microfrontend Composer Tutorial Basics](/getting-started/tutorials/microfrontend-composer/basics.mdx).
* The [Microfrontend Composer Tutorial Templates](/getting-started/tutorials/microfrontend-composer/templates.mdx).
...
* The [Microfrontend Composer Templates Tutorial](/getting-started/tutorials/microfrontend-composer/templates.mdx) where we explain how to configure other types of pages using the Microfrontend Composer Page Composer and an iFrame Page.
