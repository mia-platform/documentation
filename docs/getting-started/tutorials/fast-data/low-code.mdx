...
Now that we have one System of Records with two Projections, we [save the configuration](/getting-started/tutorials/project-usage-handbook.md#save-changes).
...
Now it's time to [save](/getting-started/tutorials/project-usage-handbook.md#save-changes) and [deploy](/getting-started/tutorials/project-usage-handbook.md#deploy-changes) the new configuration.
...
Now we can [commit](/getting-started/tutorials/project-usage-handbook.md#save-changes) our changes, [deploy](/getting-started/tutorials/project-usage-handbook.md#deploy-changes), and try our [Fast Data](/fast_data/architecture.md) sending data from the Kafka Topic, and see the result in the Single View using the endpoints.
