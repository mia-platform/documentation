---
id: fast-data-low-code-tutorial
...
Now that we have one System of Records with two Projections, we [save the configuration](/getting-started/tutorials/console/console-handbook.md#save-changes).
...
Now we can [commit](/getting-started/tutorials/console/console-handbook.md#save-changes) our changes, [deploy](/getting-started/tutorials/console/console-handbook.md#deploy-changes), and try our [Fast Data](/fast_data/architecture.md) sending data from the Kafka Topic, and see the result in the Single View using the endpoints.
