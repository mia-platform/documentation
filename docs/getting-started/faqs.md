...
* Add a Base Tag to index.html: Include `<base href="/your-path/" />` tag in your index.html file. This instructs the browser to prepend /your-path/ to all relative URLs in the application.
