...
- [CRUD](/getting-started/handbooks/console/endpoints.mdx#create-a-crud-endpoint)
- [MongoDB View](/getting-started/handbooks/console/endpoints.mdx#create-a-mongodb-view-endpoint)
- [Microservice](/getting-started/handbooks/console/endpoints.mdx#create-a-microservice-endpoint)
- [External Proxy](/getting-started/handbooks/console/endpoints.mdx#create-an-external-proxy-endpoint)
- [Cross Project Proxy](/getting-started/handbooks/console/endpoints.mdx#create-a-cross-project-proxy-endpoint)
- [Fast Data Projection](/getting-started/handbooks/console/endpoints.mdx#create-a-fast-data-projection-endpoint)
- [Fast Data Single View](/getting-started/handbooks/console/endpoints.mdx#create-a-fast-data-single-view-endpoint)
...
Now you have to click the `Create new endpoint` button and then choose the type `CRUD`.
...
To create a MongoDB View endpoint you have to move in the `Endpoint` section of the Mia-Platform Console, here you can create new endpoints.
Now you have to click the `Create new endpoint` button and then choose the type `MongoDB View`.
...
To create a Microservice endpoint you have to move in the `Endpoint` section of the Mia-Platform Console, here you can create new endpoints.
Now you have to click the `Create new endpoint` button and then choose the type `Microservice`.
...
To create an External Proxy endpoint you have to move in the `Endpoint` section of the Mia-Platform Console, here you can create new endpoints.
Now you have to click the `Create new endpoint` button and then choose the type `External Proxy`.
...
To create a Fast Data Projection endpoint you have to move in the `Endpoint` section of the Mia-Platform Console, here you can create new endpoints.
Now you have to click the `Create new endpoint` button and then choose the type `Fast Data Projection`.
...
To create a Fast Data Single View endpoint you have to move in the `Endpoint` section of the Mia-Platform Console, here you can create new endpoints.
Now you have to click the `Create new endpoint` button and then choose the type `Fast Data Projection`.
