...
Data Catalog UI can be embedded as an extension of Mia-Platform Console using [Mia-Platform Platforge Extensions](/console/console-extensibility/overview.md).
