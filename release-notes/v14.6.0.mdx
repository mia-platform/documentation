...
When updating from previous versions, run the [Fabric Admin cronjob](/docs/products/data_catalog/dc_database_setup). Then, for visualizing column lineage information of Fast Data automatic jobs, run the fast-data-job-sync (more info [here](/docs/products/data_catalog/data_catalog_job_runner#fast-data-jobs-sync)).

Refer to the [Data Catalog compatibility matrix](/docs/products/data_catalog/data_catalog_compatibility_matrix#service-latest-versions) section below for more details about latest services versions.
:::
