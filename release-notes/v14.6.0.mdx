...
Discover all the details in the [Column Lineage documentation](/docs/14.6.0/products/data_catalog/frontend/data_lineage#column-lineage).

:::note
To leverage the Column Lineage capabilities, make sure to have upgraded the following services:
- **Open Lineage v0.5.0**
- **Data Catalog Frontend v0.5.0**
- **Job Runner v0.3.0**
- **Fabric BFF v0.4.0**
- **Fabric Admin cronjob v0.5.6**

When updating from previous versions, run the [Fabric Admin cronjob](/docs/14.6.0/products/data_catalog/dc_database_setup). Then, for visualizing column lineage information of Fast Data automatic jobs, run the fast-data-job-sync (more info [here](/docs/14.6.0/products/data_catalog/data_catalog_job_runner#fast-data-jobs-sync)).

Refer to the [Data Catalog compatibility matrix](/docs/14.6.0/products/data_catalog/data_catalog_compatibility_matrix#service-latest-versions) section below for more details about latest services versions.
:::
...
For self-hosted installations, please head to the [self hosted upgrade guide](/docs/infrastructure/self-hosted/installation-chart/how-to-upgrade) or contact your Mia-Platform referent and upgrade to _Console Helm Chart_ `v15.0.12`.
...
| nexus.mia-platform.eu/console/aggregated-website                        |  1.5.62  |
...
| nexus.mia-platform.eu/console/scripts/software-catalog-sync             |  0.7.21  |
