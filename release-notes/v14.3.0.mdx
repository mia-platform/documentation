...
We introduce the **Fast Data v2**, a new suite of workloads designed to replace and significantly outperform traditional components for building Fast Data pipelines.
