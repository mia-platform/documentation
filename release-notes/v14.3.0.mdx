...
- **[Stream Processor](/docs/14.3.0/products/fast_data/fast_data_engine_v2/stream_processor/overview)** enables advanced and secure real-time data transformation, supporting both stateless and stateful processing for complex business logic
- **[Farm Data](/docs/14.3.0/products/fast_data/fast_data_engine_v2/farm_data/overview)** powers the core logic for building data products through high-performance multiple data stream aggregation
- **[Kango](/docs/14.3.0/products/fast_data/fast_data_engine_v2/kango/overview)** enables data product persistence from Kafka topics to MongoDB collections
...
Discover all the benefits and capabilities of Fast Data Engine 2.0 in the [official documentation](/docs/14.3.0/products/fast_data/fast_data_engine_v2/overview).
...
Please refer to the [documentation](/docs/14.3.0/products/software-catalog/basic-concepts/items-relationships) for more information.
...
For self-hosted installations, please head to the [self hosted upgrade guide](/docs/14.3.0/infrastructure/self-hosted/installation-chart/how-to-upgrade) or contact your Mia-Platform referent and upgrade to _Console Helm Chart_ `v15.0.3-beta.2`.
