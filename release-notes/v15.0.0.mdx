...
| **Homepage & RBAC** | `services` | `0.2.56` | [How to upgrade](/docs/requirements/installation-guidelines/shared-services/services/how-to-upgrade) |
| **Catalog** | `catalog` | `0.3.11` | [How to upgrade](/docs/requirements/installation-guidelines/catalog/how-to-upgrade) |
| **AI Foundry** | `ai-foundry` | `0.4.61` | [How to upgrade](/docs/requirements/installation-guidelines/ai-foundry/how-to-upgrade) |
...
<details>
<summary><strong>services v0.2.56</strong></summary>
...
| nexus.mia-platform.eu/platform/services/rbac-management | 0.1.1 |
...
<details>
<summary><strong>ai-foundry v0.4.61</strong></summary>

| Image repository | Version |
|---|:---:|
| docker.io/redis | 8.4.0 |
| nexus.mia-platform.eu/ai-foundry/adk-be-app | 0.7.0 |
| nexus.mia-platform.eu/ai-foundry/ai-foundry-bff | 0.3.1 |
