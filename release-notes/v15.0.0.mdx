...
| **Homepage & RBAC** | `services` | `0.2.55` | [How to upgrade](/docs/requirements/installation-guidelines/shared-services/services/how-to-upgrade) |
| **Catalog** | `catalog` | `0.3.11` | [How to upgrade](/docs/requirements/installation-guidelines/catalog/how-to-upgrade) |
...
<details>
<summary><strong>services v0.2.55</strong></summary>
...
| nexus.mia-platform.eu/platform/services/homepage | 0.3.1 |
...
<details>
<summary><strong>catalog v0.3.11</strong></summary>
...
| nexus.mia-platform.eu/ai-foundry/adk-be-app | 0.7.0 |
| nexus.mia-platform.eu/cache/envoyproxy/envoy | v1.36.2 |
| nexus.mia-platform.eu/catalog/catalog-engine | 0.7.1 |
| nexus.mia-platform.eu/catalog/catalog-mcp-server | 0.2.1 |
| nexus.mia-platform.eu/catalog/catalog-website | 0.3.1 |
