...
| **Console** | `console` | `15.0.15-alpha.08` | [How to upgrade](/docs/requirements/installation-guidelines/console/self-hosted/how-to-upgrade) |
...
| nexus.mia-platform.eu/platform/services/homepage | 0.3.0 |
...
| nexus.mia-platform.eu/cache/envoyproxy/envoy | v1.36.2 |
| nexus.mia-platform.eu/catalog/catalog-engine | 0.7.0 |
| nexus.mia-platform.eu/catalog/catalog-mcp-server | 0.2.1 |
| nexus.mia-platform.eu/catalog/catalog-website | 0.3.0 |
...
| nexus.mia-platform.eu/p4samd/core/policy-engine | 0.9.0 |
