...
**Infrastructure Projects** — the dedicated Project type introduced in v14 to provision and manage infrastructure following the *Infrastructure as Code* (IaC) paradigm — are deprecated with this release. The feature never left its [BETA stage](/release-notes/info/version_policy#feature-preview-and-beta) and has now been discontinued.

Starting from v15.0.0:

* it is no longer possible to create new Infrastructure Projects;
* existing Infrastructure Projects can no longer be used to manage infrastructure components or to run `plan` and `apply` deployments;
* the related documentation pages have been removed.

If you are currently relying on Infrastructure Projects, please contact your Mia-Platform referent to evaluate the most suitable alternative for your infrastructure provisioning workflows.
...
| **Console** | `console` | `15.0.15-0` | [How to upgrade](/docs/requirements/installation-guidelines/console/self-hosted/how-to-upgrade) |
