...
Mia-Platform v15.0.0 is **now in Preview** and will be generally available by the July 16th!

Mia-Platform SaaS users can try out v15.0.0 latest improvements in Preview!

For self-hosted installations, please read the [following guidelines](#how-to-update).
:::
