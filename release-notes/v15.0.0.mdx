...
To learn more about the features available in the new Charts section of the Design Area, and to understand how chart configuration files deployment is handled via Kustomize, CI/CD pipelines, and MLP, please refer to the [Configure Helm Charts documentation](/docs/products/console/api-console/api-design/charts).
