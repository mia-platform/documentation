...
| **Auth — Realm Management** | `keycloak-realm-management` | `0.1.26` | [How to upgrade](/docs/requirements/installation-guidelines/shared-services/authn/keycloak-realm-management/how-to-upgrade) |
| **Homepage & RBAC** | `services` | `0.2.54` | [How to upgrade](/docs/requirements/installation-guidelines/shared-services/services/how-to-upgrade) |
| **Catalog** | `catalog` | `0.3.10` | [How to upgrade](/docs/requirements/installation-guidelines/catalog/how-to-upgrade) |
| **AI Foundry** | `ai-foundry` | `0.4.55` | [How to upgrade](/docs/requirements/installation-guidelines/ai-foundry/how-to-upgrade) |
| **Console** | `console` | `15.0.15-alpha.1` | [How to upgrade](/docs/requirements/installation-guidelines/console/self-hosted/how-to-upgrade) |
...
<details>
<summary><strong>keycloak-realm-management v0.1.26</strong></summary>
...
<details>
<summary><strong>services v0.2.54</strong></summary>
...
| nexus.mia-platform.eu/platform/auth/access-control/ext-authz | latest-nocache |
...
<details>
<summary><strong>catalog v0.3.10</strong></summary>
...
| nexus.mia-platform.eu/platform/auth/access-control/ext-authz | 0.2.0-nocache |
| nexus.mia-platform.eu/platform/auth/authtool/authtool-bff | 0.5.2 |
...
<details>
<summary><strong>ai-foundry v0.4.55</strong></summary>

| Image repository | Version |
|---|:---:|
| docker.io/redis | 8.4.0 |
| nexus.mia-platform.eu/ai-foundry/adk-be-app | 0.7.0 |
| nexus.mia-platform.eu/ai-foundry/ai-foundry-bff | 0.3.0 |
| nexus.mia-platform.eu/ai-foundry/ai-foundry-website | 0.7.0 |
| nexus.mia-platform.eu/cache/envoyproxy/envoy | v1.36.2 |
| nexus.mia-platform.eu/platform/auth/access-control/ext-authz | 0.2.1-nocache |
| nexus.mia-platform.eu/platform/auth/authtool/authtool-bff | 0.5.2 |
| quay.io/docling-project/docling-serve-cpu | v1.24.0 |
...
<details>
<summary><strong>console v15.0.15-alpha.1</strong></summary>
