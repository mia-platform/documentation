...
| **Auth — Realm Management** | `keycloak-realm-management` | `0.1.20` | [How to upgrade](/docs/requirements/installation-guidelines/shared-services/authn/keycloak-realm-management/how-to-upgrade) |
...
<details>
<summary><strong>keycloak-realm-management v0.1.20</strong></summary>
...
| nexus.mia-platform.eu/platform/services/rbac-management | 0.1.0 |
