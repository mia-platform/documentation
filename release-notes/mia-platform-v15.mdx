...
This year's headline news is the arrival of three brand-new components of Mia-Platform: **Catalog**, **Flow**, and **AI Foundry**, which expand the platform into context management, workflow orchestration, and AI-powered development.
...
We are thrilled to welcome a brand-new component to the Mia-Platform Product Suite: **Catalog**!

Catalog is the centralized place where teams record, classify, and connect any entity that exists in their organization — software components, infrastructure resources, datasets, AI assets, business processes — and make them discoverable across the platform.

![Catalog](./img/catalog.png)

Catalog ships with:

- A **Catalog App** to browse, create, and curate items, and navigate the relationship graph.
...
Discover all the details in the [Catalog documentation](/docs/products/catalog/overview).
...
## Mia-Platform v15 Fall Update

### Catalog Item Versioning

### Agentic Workflows in AI Foundry
