...
For detailed usage examples, please refer to the [documentation](/docs/14.2.1/products/console/api-console/api-design/miactl-commands) and the [miactl project commands](/docs/14.2.1/products/console/cli/miactl/commands#project).
...
For self-hosted installations, please head to the [self hosted upgrade guide](/docs/14.2.1/infrastructure/self-hosted/installation-chart/how-to-upgrade) or contact your Mia-Platform referent and upgrade to _Console Helm Chart_ `v15.0.1`.
