...
For self-hosted installations, please head to the [self hosted upgrade guide](/docs/14.5.2/infrastructure/self-hosted/installation-chart/how-to-upgrade) or contact your Mia-Platform referent and upgrade to _Console Helm Chart_ `v15.0.10-beta.1`.
...
| nexus.mia-platform.eu/console/aggregated-website                       | 1.5.60     |
...
| nexus.mia-platform.eu/console/deploy-service                           | 8.2.1      |
