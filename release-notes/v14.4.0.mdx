...
:::note
The *Inheritance of Custom Properties* feature (Beta), has been officially **phased out** with the [latest service updates](/docs/products/data_catalog/data_catalog_compatibility_matrix#service-latest-versions) of the Data Catalog application.  
