...
| **Homepage & RBAC** | `services` | `v0.3.16` | [How to upgrade](/docs/requirements/installation-guidelines/shared-services/services/how-to-upgrade) |
| **Catalog** | `catalog` | `v0.3.42-0` | [How to upgrade](/docs/requirements/installation-guidelines/catalog/how-to-upgrade) |
| **AI Foundry** | `ai-foundry` | `v0.4.83-0` | [How to upgrade](/docs/requirements/installation-guidelines/ai-foundry/how-to-upgrade) |
| **Console** | `console` | `v15.1.0` | [How to upgrade](/docs/requirements/installation-guidelines/console/self-hosted/how-to-upgrade) |
...
<details>
<summary><strong>services v0.3.16</strong></summary>
...
| nexus.mia-platform.eu/platform/services/homepage | 0.4.5 |
| nexus.mia-platform.eu/platform/services/rbac-management | 0.3.3 |
...
<details>
<summary><strong>catalog v0.3.42-0</strong></summary>
...
<details>
<summary><strong>ai-foundry v0.4.83-0</strong></summary>

| Image repository | Version |
|---|:---:|
| docker.io/redis | 8.4.0 |
| nexus.mia-platform.eu/ai-foundry/adk-be-app | 0.7.4 |
| nexus.mia-platform.eu/ai-foundry/ai-foundry-bff | 0.3.3 |
| nexus.mia-platform.eu/ai-foundry/ai-foundry-website | 0.7.4 |
| nexus.mia-platform.eu/cache/envoyproxy/envoy | v1.36.2 |
| nexus.mia-platform.eu/platform/auth/access-control/ext-authz | 0.2.2-nocache |
| nexus.mia-platform.eu/platform/auth/authtool/authtool-bff | 0.5.2 |
| quay.io/docling-project/docling-serve-cpu | v1.24.0 |
...
<details>
<summary><strong>console v15.1.0</strong></summary>
