...
| **Homepage & RBAC** | `services` | `v0.3.25` | [How to upgrade](/docs/15.2.0/requirements/installation-guidelines/shared-services/services/how-to-upgrade) |
...
| **Console** | `console` | `v15.2.0-beta.1` | [How to upgrade](/docs/15.2.0/requirements/installation-guidelines/console/self-hosted/how-to-upgrade) |
...
<details>
<summary><strong>services v0.3.25</strong></summary>
...
| nexus.mia-platform.eu/platform/services/homepage | 0.4.8 |
| nexus.mia-platform.eu/platform/services/rbac-management | 0.4.0 |
...
<details>
<summary><strong>console v15.2.0-beta.1</strong></summary>
...
| nexus.mia-platform.eu/console/extensibility-manager                     |   3.0.1   |
