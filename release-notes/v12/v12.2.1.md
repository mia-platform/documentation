...
Check the [`miactl marketplace list` command documentation](/docs/12.x.x/cli/miactl/commands#list-5) for more information.
...
A migration guide is available [here](/docs/12.x.x/runtime_suite/crud-service/guides/migration-guide-v7) to aid you in migrating your existing CRUD services to version `v7.0.0`.
