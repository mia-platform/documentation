...
[IAM section](/docs/12.x.x/development_suite/identity-and-access-management/index) has been enriched with User Groups Management.  
...
Discover more about the power of our CLI and [visit the official miactl documentation](/docs/12.x.x/cli/miactl/10_overview).
