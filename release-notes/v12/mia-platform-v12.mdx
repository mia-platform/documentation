---
id: v12-overview
title: Welcome to Mia-Platform v12
...
It can be safely used but there may be still be some missing features, check the [roadmap section](/docs/12.4.0/development_suite/set-up-infrastructure/enhanced-project-workflow#roadmap-and-future-improvements) below to find out more.
:::

To learn more about all the advantages offered by this feature and its future developments roadmap, take a look at the video below and read the [official documentation](/docs/12.4.0/development_suite/set-up-infrastructure/enhanced-project-workflow).
...
To learn more, please refer to the [documentation](/docs/12.4.0/fast_data/configuration/config_maps/aggregation#use-the-no-code).
...
To learn more about this feature, visit the [related documentation](/docs/12.4.0/fast_data/configuration/import_export).
...
For more info, go to the [documentation](/docs/12.4.0/fast_data/architecture#event-driven-architecture).
...
To learn more about this feature, take a look at the video below and read the [official documentation](/docs/12.4.0/marketplace/add_to_marketplace/contributing_overview#public-and-internal-company-marketplace).
...
:::info
This feature is in Preview and is exclusively available for SaaS users. Activate it from [Feature Preview](/docs/12.4.0/development_suite/user-settings/feature-preview) section to test it.
:::
...
To learn more, take a look at the video below and read the [official documentation](/docs/12.4.0/development_suite/webhooks-and-events/webhooks)
...
For more information, [go to the official documentation](/docs/12.4.0/console/project-configuration/project-settings).
...
For more information, [go to the documentation](/docs/12.4.0/development_suite/api-console/api-design/listeners).

![Listeners](./img/listeners.png)

## User Groups Management

[IAM section](/docs/12.4.0/development_suite/identity-and-access-management) has been enriched with User Groups Management.  
...
For more information, [go to the documentation](/docs/12.4.0/development_suite/identity-and-access-management/manage-groups).
...
For more information, [go to the documentation](/docs/12.4.0/development_suite/monitoring/resources/cronjobs#manually-launching-a-cronjob).
...
For more information, go to the [documentation](/docs/12.4.0/console/project-configuration/manage-environment-variables/manage-environment-variables-with-akv).
...
Discover more about the power of our CLI and [visit the official miactl documentation](/docs/12.4.0/cli/miactl/overview).
