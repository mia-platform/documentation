...
For more information, go to the [documentation](/docs/14.2.1/products/console/set-up-infrastructure/env-based-management) and visit [Mia-Platform Console v14 Overview](/release-notes/mia-platform-v14.mdx#environment-centric-workflow-for-projects-only-for-enhanced-projects-beta).
