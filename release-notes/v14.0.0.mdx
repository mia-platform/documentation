...
For more information, go to the [documentation]/docs(/products/console/console-extensibility/sso) and visit [Mia-Platform Console v14 Overview](/release-notes/mia-platform-v14#iframe-extensions-support-login-with-console-sso).
