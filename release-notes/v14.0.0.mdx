...
For more information, go to the [documentation](/docs/products/console/console-extensibility/extension-sso) and visit [Mia-Platform Console v14 Overview](/release-notes/mia-platform-v14.mdx#iframe-extensions-support-login-with-console-sso).
...
With v14, the **Software Catalog** gets a powerful upgrade. We’ve refined how items are managed and introduced clearer, standardized schemas — fully documented and easily accessible for all through our [official documentation](/docs/products/software-catalog/overview).
...
We recommend updating any existing integrations to align with the [latest APIs](/docs/products/software-catalog/items-management/api) to ensure long-term compatibility and support.
