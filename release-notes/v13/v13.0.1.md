...
For more information, please refer to the [Sidecars documentation page](/docs/13.x.x/console/design-your-projects/sidecars#clone-a-sidecar).
...
For more information, visit the [dedicated documentation](/docs/13.x.x/development_suite/api-console/api-design/crud_advanced#how-to-generate-from-data-sample-your-crud-fields).
...
Doing this will replace the current fields with those contained within the file.
The supported file extensions are: `.csv` and `.json`.
For more information, visit the [dedicated documentation](/docs/13.x.x/fast_data/configuration/single_views#generate-single-view-fields-from-data-sample)
...
For self-hosted installations, please head to the [self hosted upgrade guide](/docs/13.x.x/infrastructure/self-hosted/installation-chart/how-to-upgrade) or contact your Mia-Platform referent and upgrade to _Console Helm Chart_ `v13.3.6`.
