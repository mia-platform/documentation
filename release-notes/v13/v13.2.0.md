...
To find out how Data Catalog works and all the benefits for your Company Data Governance, visit the [official documentation](/docs/13.7.5/data_catalog/overview_data_catalog)!
...
If you want to discover more about the potentiality of Marketplace resource versioning and how it works, head to the [dedicated section](/docs/13.7.5/software-catalog/manage-items/overview-manage-items#set-controlled-versions-for-your-marketplace-resources-and-make-them-available-to-users) inside the [Company Marketplace](/docs/13.7.5/software-catalog/manage-items/overview-manage-items) documentation page.

Visit also the [Plugins](/docs/13.7.5/software-catalog/manage-items/mia-ctl/create/create-item-by-type/create_plugin) and [Custom Resources](/docs/13.7.5/software-catalog/manage-items/mia-ctl/create/create-item-by-type/create_infrastructure_resource) documentations for more information about how to correctly create and manage them.
...
[**Fast Data Control Plane**](/docs/13.7.5/runtime_suite_applications/fast-data-control-plane/overview) application has been empowered to become the single central access point for governing the Fast Data Runtime of your entire Company.

![Control Plane Company level](img/control_plane_in_console.png)

In order to be able to keep track of the state of the different Fast Data pipelines deployed in the various runtime environments of your Fast Data Projects, it is necessary to configure and release the [Control Plane Operator](/docs/13.7.5/runtime_suite/fast-data-control-plane-operator/overview) plugin in each of those runtime environments.  
...
To find out how Fast Data Control Plane works and all the benefits of this Runtime Management solution, visit the [official documentation](/docs/13.7.5/fast_data/runtime_management/overview).
...
[`Mia Console` target](/docs/13.7.5/runtime_suite_templates/data-catalog-agent/configuration#mia-console) has been deprecated in favour of [`mia-open-lineage` target](/docs/13.7.5/runtime_suite_templates/data-catalog-agent/configuration#mia-openlineage) to support [Data Catalog](/docs/13.7.5/data_catalog/overview_data_catalog) solution.

#### Added

New Data Catalog Agent [targets](/docs/13.7.5/runtime_suite_templates/data-catalog-agent/configuration#targets) has been added:

* [`mia-open-lineage` target](/docs/13.7.5/runtime_suite_templates/data-catalog-agent/configuration#mia-openlineage) to feed data from external sources to the [Data Catalog](/docs/13.7.5/data_catalog/overview_data_catalog) application.

To discover more about how to configure this target, visit the [related documentation](/docs/13.7.5/runtime_suite_templates/data-catalog-agent/configuration#mia-openlineage).
...
For self-hosted installations, please head to the [self hosted upgrade guide](/docs/13.7.5/infrastructure/self-hosted/installation-chart/how-to-upgrade) or contact your Mia-Platform referent and upgrade to _Console Helm Chart_ `v13.7.3`.
