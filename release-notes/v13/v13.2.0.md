...
[`Mia Console` target](/docs/13.x.x/runtime_suite_templates/data-catalog-agent/20_configuration#mia-console) has been deprecated in favour of [`mia-open-lineage` target](/docs/13.x.x/runtime_suite_templates/data-catalog-agent/20_configuration#mia-openlineage) to support [Data Catalog](/docs/13.x.x/data_catalog/overview) solution.

#### Added

New Data Catalog Agent [targets](/docs/13.x.x/runtime_suite_templates/data-catalog-agent/20_configuration#targets) has been added:

* [`mia-open-lineage` target](/docs/13.x.x/runtime_suite_templates/data-catalog-agent/20_configuration#mia-openlineage) to feed data from external sources to the [Data Catalog](/docs/13.x.x/data_catalog/overview) application.

To discover more about how to configure this target, visit the [related documentation](/docs/13.x.x/runtime_suite_templates/data-catalog-agent/20_configuration#mia-openlineage).
