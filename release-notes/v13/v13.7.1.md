...
For more details, check the related [documentation](/docs/13.7.5/console/company-configuration/company-settings).
...
Learn more about the Debug command in the related [Mia-Assistant documentation](/docs/13.7.5/console/assistant/overview).
...
For self-hosted installations, please head to the [self hosted upgrade guide](/docs/13.7.5/infrastructure/self-hosted/installation-chart/how-to-upgrade) or contact your Mia-Platform referent and upgrade to _Console Helm Chart_ `v14.1.1`.
