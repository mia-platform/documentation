...
For more information, please visit the [documentation page](/docs/13.x.x/console/design-your-projects/custom-resources/custom-resources) and explore some helpful [use cases](/docs/13.x.x/console/design-your-projects/custom-resources/use-cases).
...
To discover more, please refer to the [documentation](/docs/13.x.x/console/design-your-projects/custom-resources/custom-resources).
...
* Introduced the support for connecting to the storage using TLS/SSL connection. For more information about how to configure it, visit the related SSL connection [documentation](/fast_data/configuration/projection_storer#ssl-connection)
...
The latest services versions are reported [here](/docs/13.x.x/data_catalog/compatibility_matrix#service-latest-versions).  
