...
For more information, please visit the [documentation page](/docs/13.x.x/console/design-your-projects/custom-resources) and explore some helpful [use cases](/docs/13.x.x/console/design-your-projects/custom-resources/custom-resources-use-cases).
...
* Introduced the support for connecting to the storage using TLS/SSL connection. For more information about how to configure it, visit the related SSL connection [documentation](/docs/13.x.x/fast_data/configuration/projection_storer_config#ssl-connection)
