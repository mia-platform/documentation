...
More information will be provided with future Console updates. To discover more about Enhanced Project Workflow, visit the related [documentation page](/docs/13.x.x/development_suite/set-up-infrastructure/overview).
:::
...
In addition, make sure to upgrade [`miactl`](/docs/13.x.x/cli/miactl/10_overview) to version 0.15 to make use of the new format.
:::
