...
To discover more, head to the [Extensions documentation page](/docs/13.x.x/console/company-configuration/extensions). 
...
For more information, visit the related [documentation page](/docs/13.x.x/development_suite/deploy/overview#compare-changes).
...
More information will be provided with future Console updates. To discover more about Enhanced Project Workflow, visit the related [documentation page](/docs/13.x.x/development_suite/set-up-infrastructure/enhanced-project-workflow).
:::
...
In addition, make sure to upgrade [`miactl`](/docs/13.x.x/cli/miactl/overview) to version 0.15 to make use of the new format.
:::
...
For self-hosted installations, please head to the [self hosted upgrade guide](/docs/13.x.x/infrastructure/self-hosted/installation-chart/how-to-upgrade) or contact your Mia-Platform referent and upgrade to _Console Helm Chart_ `v13.7.1`.
