...
For further details, please refer to the [documentation](/docs/13.x.x/microfrontend-composer/composer/structure#translations).
...
Try it out and see the [documentation](/docs/13.x.x/microfrontend-composer/composer/structure#components-explorer) for more details.
...
API Portal version `2.0.1` is now [served directly](/docs/13.x.x/runtime_suite/swagger-aggregator/apis#static-route) from Swagger Aggregator version `3.7.0`.
