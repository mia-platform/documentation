...
For more details, please refer to [the documentation](/docs/13.x.x/software-catalog/manage-items/software-catalog-ui/overview).
...
Check the [Audit Trail sidecar documentation](/docs/13.x.x/runtime_suite/audit-trail/10_overview) for additional information about architecture, configuration and usage.
