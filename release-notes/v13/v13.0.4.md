...
For more information about how to configure it, head to the [installation chart documentation](/docs/13.7.5/infrastructure/self-hosted/installation-chart/helm-values/assistant).
...
To discover more about such new commands, head to the related [documentation page](/docs/13.7.5/cli/miactl/commands#extensions).
...
For self-hosted installations, please head to the [self hosted upgrade guide](/docs/13.7.5/infrastructure/self-hosted/installation-chart/how-to-upgrade) or contact your Mia-Platform referent and upgrade to _Console Helm Chart_ `v13.5.1`.
