...
For more information about how to configure it, head to the [installation chart documentation](/docs/13.x.x/infrastructure/self-hosted/installation-chart/helm-values/assistant).
