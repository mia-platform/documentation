...
For more details, please refer to [the documentation](/docs/13.x.x/software-catalog/manage-items/software-catalog-ui/update/overview-software-catalog-update)
...
You can find more information on the plugin [here](/docs/13.x.x/runtime_suite/crud-sql/overview).
