...
To learn more, please refer to the [documentation](/docs/13.x.x/console/console-extensibility/extensibility-overview).
...
To discover more, please refer to the [documentation page](/docs/13.x.x/console/design-your-projects/custom-resources/custom-resources) and check out some useful [use cases](/docs/13.x.x/console/design-your-projects/custom-resources/custom-resources-use-cases).
...
To find out how it works and all the benefits of Mia-Platform Data Catalog, please refer to the related [documentation](/docs/13.x.x/data_catalog/overview_data_catalog).
