...
### Extend Mia-Platform Console using... the Console! | <Highlight color="#1890FF">v13.3.x</Highlight>
...
To discover more about how to manage your Extensions and the types of supported extensions, head to the [Extensions documentation](/docs/13.7.5/console/company-configuration/extensions).
...
To learn more, please refer to the [documentation](/docs/13.7.5/console/console-extensibility/extensibility-overview).
...
To learn more, please refer to the [documentation](/docs/13.7.5/console/company-configuration/webhooks#event-history).
...
#### Support to all Infrastructure Resources | <Highlight color="#1890FF">v13.3.x</Highlight>
...
To discover more, please refer to the [documentation page](/docs/13.7.5/console/design-your-projects/custom-resources) and check out some useful [use cases](/docs/13.7.5/console/design-your-projects/custom-resources/custom-resources-use-cases).

#### Support of Custom Kubernetes Resources in Runtime area | <Highlight color="#1890FF">v13.3.x</Highlight>
...
To discover more, you can refer to the [documentation](/docs/13.7.5/console/design-your-projects/custom-resources).
...
### Data Catalog Application | <Highlight color="#1890FF">v13.3.x</Highlight>  
...
To find out how it works and all the benefits of Mia-Platform Data Catalog, please refer to the related [documentation](/docs/13.7.5/data_catalog/overview_data_catalog).

### Software Catalog | <Highlight color="#1890FF">v13.3.x</Highlight>
...
### Versioning management of Marketplace resources | <Highlight color="#1890FF">v13.3.x</Highlight>
...
If you want to discover more, head to the [dedicated section](/docs/13.7.5/software-catalog/manage-items/overview-manage-items#set-controlled-versions-for-your-marketplace-resources-and-make-them-available-to-users) inside the [Company Marketplace](/docs/13.7.5/software-catalog/manage-items/overview-manage-items) documentation page.
...
- **[Initial Load and Full Refresh processes management](/docs/13.7.5/fast_data/concepts/data_loading)**, thanks to a user-friendly interface and without altering the configuration of your workloads deployed in runtime
...
To learn more, please refer to the related [documentation](/docs/13.7.5/fast_data/runtime_management/overview).
...
Explore [our documentation](/docs/13.7.5/development_suite/api-console/api-design/flow-manager-configurator/overview) for more details.
...
To learn more, please refer to the related [documentation](/docs/13.7.5/console/company-configuration/project-blueprint).
...
To discover more about how to configure and manage Sidecars, visit the related [documentation page](/docs/13.7.5/console/design-your-projects/sidecars).
...
### AI RAG Chat application | <Highlight color="#1890FF">v13.3.x</Highlight>
