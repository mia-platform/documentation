...
To discover more, please refer to the [documentation page](/docs/13.x.x/console/design-your-projects/custom-resources) and check out some useful [use cases](/docs/13.x.x/console/design-your-projects/custom-resources-use-cases).
