...
To discover more about how to manage your Extensions and the types of supported extensions, head to the [Extensions documentation](/docs/13.x.x/console/company-configuration/extensions).
...
To learn more, please refer to the [documentation](/docs/13.x.x/console/console-extensibility/overview).
...
To learn more, please refer to the [documentation](/docs/13.x.x/console/company-configuration/webhooks#event-history).
...
To discover more, please refer to the [documentation page](/docs/13.x.x/console/design-your-projects/custom-resources/custom-resources) and check out some useful [use cases](/docs/13.x.x/console/design-your-projects/custom-resources/use-cases).
...
To discover more, you can refer to the [documentation](/docs/13.x.x/console/design-your-projects/custom-resources/custom-resources).
...
To find out how it works and all the benefits of Mia-Platform Data Catalog, please refer to the related [documentation](/docs/13.x.x/data_catalog/overview).
...
If you want to discover more, head to the [dedicated section](/docs/13.x.x/software-catalog/manage-items/overview#set-controlled-versions-for-your-marketplace-resources-and-make-them-available-to-users) inside the [Company Marketplace](/docs/13.x.x/software-catalog/manage-items/overview) documentation page.
...
- **[Initial Load and Full Refresh processes management](/docs/13.x.x/fast_data/concepts/data_loading)**, thanks to a user-friendly interface and without altering the configuration of your workloads deployed in runtime
...
To learn more, please refer to the related [documentation](/docs/13.x.x/fast_data/runtime_management/overview).
...
Explore [our documentation](/docs/13.x.x/development_suite/api-console/api-design/flow-manager-configurator/overview) for more details.
...
To learn more, please refer to the related [documentation](/docs/13.x.x/console/company-configuration/project-blueprint).
...
To discover more about how to configure and manage Sidecars, visit the related [documentation page](/docs/13.x.x/console/design-your-projects/sidecars).
