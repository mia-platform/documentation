...
For more information, visit the [documentation page](/docs/13.x.x/console/company-configuration/providers/management#supported-credential-types).
...
Fast Data Control Plane Operator has been updated to [v0.3.0](/docs/13.x.x/runtime_suite/fast-data-control-plane-operator/changelog).
