...
To discover more about Environment Configuration Promotion and the Simplified mode, head to the related [documentation page](/docs/14.2.1/products/console/set-up-infrastructure/env-based-management#simplified-mode).
...
For self-hosted installations, please head to the [self hosted upgrade guide](/docs/14.2.1/infrastructure/self-hosted/installation-chart/how-to-upgrade) or contact your Mia-Platform referent and upgrade to _Console Helm Chart_ `v14.2.2`.
