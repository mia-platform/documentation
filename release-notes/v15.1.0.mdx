...
|---|---|---|---|
| **Auth — Keycloak** | `keycloak-operator` | `v0.6.0` | [How to upgrade](/docs/requirements/installation-guidelines/shared-services/authn/keycloak/how-to-upgrade) |
...
| **Catalog** | `catalog` | `v0.3.41-2` | [How to upgrade](/docs/requirements/installation-guidelines/catalog/how-to-upgrade) |
| **AI Foundry** | `ai-foundry` | `v0.4.82-1` | [How to upgrade](/docs/requirements/installation-guidelines/ai-foundry/how-to-upgrade) |
...
<details>
<summary><strong>keycloak-operator v0.6.0</strong></summary>
...
<details>
<summary><strong>catalog v0.3.41-2</strong></summary>
...
<details>
<summary><strong>ai-foundry v0.4.82-1</strong></summary>
