...
This release brings powerful new capabilities designed to help teams build, operate, and govern data products with greater **power** and **control**.
From a next-generation Fast Data engine that boosts performances, to expanded catalog features that enhance governance and flexibility.

### Fast Data Engine 2.0

**Fast Data Engine 2.0** introduces a new suite of workloads that redefine how real-time data pipelines are built and optimized.
- *Stream Processor* enables advanced and secure real-time data transformation, supporting both stateless and stateful processing for complex business logic.
- *Farm Data* powers high-performance aggregation across multiple data streams, forming the core of modern data products
- *Kango* provides seamless persistence from Kafka topics to MongoDB collections.

Experience up to **10× faster aggregation performance**, unlocking scalable and efficient Fast Data pipelines for even the most demanding workloads.
Discover all the benefits of Fast Data Engine 2.0 in the [official documentation].

### Excel Plugin – coming soon
A new Excel integration designed to bring data products directly where users work every day. (More details to follow in upcoming updates.)
