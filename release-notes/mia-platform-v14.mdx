---
id: v14-overview
title: Welcome to Mia-Platform v14
...
## Mia-Platform v14 Fall Edition

**The speed of Power. The confidence of Control.**

This release brings powerful new capabilities designed to help teams build, operate, and govern software and data products with greater **power** and **control**.
From a next-generation Fast Data engine that boosts performances of real-time data pipelines, to expanded catalog features that enhance governance and flexibility.

### Fast Data Engine 2.0

Fast Data Engine 2.0 introduces a new suite of workloads that take real-time data pipeline development and optimization to the next level.  
The engine delivers advanced, secure stream processing and achieves up to **10× faster aggregation performance**, ensuring scalable efficiency even for large-scale production environments.  

New modular data pipelines not only enable faster aggregations, but also personalized business scenarios.

![Fast Data Engine v2](img/fast-data-engine-v2.png)

Discover the new Fast Data suite and all the benefits of Fast Data Engine 2.0 in the [official documentation](/docs/products/fast_data/fast_data_engine_v2/overview).
...
By bridging the gap between Excel and the Data Catalog, it simplifies advanced metadata enrichment while ensuring data quality and governance standards are maintained.  

![Data Catalog Excel Add-in](img/data-catalog-excel-add-in.png)

To discover all the benefits and how to use the Data Catalog Excel Add-in, visit the [official documentation](/docs/next/products/data_catalog/excel_add_in/overview).

### Enhanced Software Catalog

The Software Catalog now supports **custom item types**, extending beyond predefined entities to model internal tools, components, or processes in a unified way.
Custom items can be registered, organized, and documented like any other catalog entry — offering greater flexibility in representing your software ecosystem.
...
- Mapping *relationships* between existing and custom entities with user-defined schemas.
...
### AI-Enhanced Vibe Platform with Mia-Assistant

Mia-Assistant is now a full operational MCP Client capable of querying and interacting with multiple MCP Servers for faster productivity. It provides real-time access to Console data, service checks, debugging, and automatic deployments—all via chat. This creates a unified, **AI-powered vibe platform experience**, offering constant, seamless support to elevate your daily workflows.  

![AI-Enhanced Vibe Platform](img/vibe-ai-platform.png)

The v14 Fall Release brings several powerful new features:
- **Remote access** to the Console MCP Server, enabling AI-powered operations from external tools like Visual Studio Code.
- **Pin chat** to keep Mia-Assistant open while working, ensuring uninterrupted assistance.
- **Export conversations** in both **PDF** and **.txt** formats for easy sharing and archiving.
- **Chat history view** to revisit and reopen past interactions with a single click.

### Manage Projects locally with miactl

The miactl CLI now lets you manage Project configurations locally with the new `describe` and `apply` commands — export, edit, and reapply changes seamlessly for easier troubleshooting misconfiguration, migration, and reuse.

Refer to the [documentation](/docs/products/console/api-console/api-design/miactl-commands) for more details.

---

# Mia-Platform v14 - May 2025
...
To learn more about all the features and how to configure it, visit the [official documentation](/docs/runtime-components/plugins/integration-connector-agent/overview).
...
### Environment-centric workflow for Projects (only for Enhanced Projects)
