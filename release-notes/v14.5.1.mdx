...
For self-hosted installations, please head to the [self hosted upgrade guide](/docs/infrastructure/self-hosted/installation-chart/how-to-upgrade) or contact your Mia-Platform referent and upgrade to _Console Helm Chart_ `v15.0.9-beta.0`.
...
| nexus.mia-platform.eu/console/aggregated-website                        |     1.5.57      |
| nexus.mia-platform.eu/console/api-gateway                               |      0.2.9      |
| nexus.mia-platform.eu/console/backend                                   |     32.9.0      |
...
| nexus.mia-platform.eu/console/scripts/software-catalog-sync             |     0.7.17      |
| nexus.mia-platform.eu/console/scripts/version-upgrader                  | 11.1.2-hotfix.0 |
