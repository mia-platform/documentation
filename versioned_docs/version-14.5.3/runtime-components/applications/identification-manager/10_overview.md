...
With the elements available in the [marketplace](/runtime-components/overview_marketplace.md) it is possible to define a set of different identification processes, each of them with their custom identification steps, in particular:
