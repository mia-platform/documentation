...
[Chat Service Backend](/runtime-components/plugins/chat-service-backend/10_overview_and_usage.md).
...
The data served from the backend allows so the direct connection with the external Stream Chat provider through secured endpoints and websocket connections, granting at the same time interoperability with other Mia-platform Services such as the [Microfrontend Composer](/products/microfrontend-composer/overview.md) and the [Authentication Service](/runtime-components/plugins/authentication-service/10_overview.md).
...
For them integration of the application as a Backoffice plugin and the offered customization options, refer to the [configuration](/runtime-components/plugins/chat-service-frontend/20_configuration.md) and [customization](/runtime-components/plugins/chat-service-frontend/30_customization.md) sections.
...
- [Setup the service](/runtime-components/plugins/chat-service-frontend/20_configuration.md)
- [Custom theming and application's options](/runtime-components/plugins/chat-service-frontend/30_customization.md)
