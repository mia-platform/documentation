...
Once you [created a Company](/products/console/company-configuration/create-company.md), you can configure:
...
To connect a cluster, you can follow the [clusters connection guide](/products/console/company-configuration/clusters-management/connect-and-manage-cluster.mdx).
...
For further details on how to create new providers, you can follow the [providers configuration guide](/products/console/company-configuration/providers/overview.md).
...
For further details on how to configure new project defaults, you can follow the [project configuration guide](/products/console/company-configuration/project-default-configuration.mdx).
...
For further details on how to manage Company settings, you can refer to the [dedicated page](/products/console/company-configuration/settings.md).
