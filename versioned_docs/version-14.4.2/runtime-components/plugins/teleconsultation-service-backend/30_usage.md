...
[console-mia-headers]: /runtime-components/plugins/authorization-service/30_usage.md#headers-set-by-auth
...
[crud-user-id-map]: /runtime-components/plugins/teleconsultation-service-backend/20_configuration.md#user-id-map-crud
