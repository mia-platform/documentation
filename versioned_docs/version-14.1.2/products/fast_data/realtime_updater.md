...
To know more about Real-Time Updater service Configurations you can go [here](/products/fast_data/configuration/realtime-updater/realtime-updater.md)
...
- it could generate an event to inform of the update of a specific projection (this update will be sent to a Kafka topic, as explained in the [Real-Time Updater Low Code](/products/fast_data/configuration/realtime-updater/configuration-files.md#kafka-projection-updates-configuration))
...
For further information, you can refer to the [Real-Time Updater Configuration](/products/fast_data/configuration/realtime-updater/realtime-updater.md) page.
