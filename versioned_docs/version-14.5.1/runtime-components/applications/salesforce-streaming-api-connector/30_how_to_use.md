...
As described in section [Connector in Depth](/runtime-components/applications/salesforce-streaming-api-connector/11_connector_in_depth.md), you need to create a CRUD collection named
