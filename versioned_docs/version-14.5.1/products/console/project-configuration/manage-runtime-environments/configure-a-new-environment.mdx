...
Further information about the variables used by the pipeline and how to configure it can be found [here](/infrastructure/self-hosted/pipeline-configuration.md).
...
More information about the IngressRoute configuration can be found [here](/infrastructure/paas/tools/traefik.md).
