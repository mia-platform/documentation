...
As described into the [environment variables section](/runtime-components/plugins/timer-service/20_configuration.md#environment-variables), the kafka configuration is optional (not all projects use kafka).
