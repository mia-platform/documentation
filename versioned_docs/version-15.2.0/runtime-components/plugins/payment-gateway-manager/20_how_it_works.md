...
More details about custom external integrations are available on the [dedicated section](/runtime-components/plugins/payment-gateway-manager/30_payment_providers/99_external.md).
...
More details about flow manager integrations are available on the [dedicated section](/runtime-components/plugins/payment-gateway-manager/40_flow_manager_integration.md).
