...
This service can be added to your project by visiting Mia-Platform [Marketplace](/runtime-components/overview_marketplace.md) and creating a new microservice from the **Swagger Aggregator** plugin.

It is also possible to expose your Swagger Aggregator microservice with multiple endpoints, each of them with a specific purpose. For example, you can [create three endpoints](/products/console/api-console/api-design/endpoints.md) with the following paths:

- `/documentations/api-portal/api`: this endpoint is necessary to retrieve the aggregated Open API specification document shown in the [Documentation Portal](/products/console/project-configuration/documentation-portal.md) through the graphical interface generated by the [API Portal](/runtime-components/plugins/api-portal/10_overview.md) plugin.
...
:::tip
Configure Swagger Aggregator directly from [Console](/products/console/api-console/advanced-section/swagger-aggregator/configuration.md)
:::
...
:::info
For additional information about more advanced properties that can be defined in the swagger-aggregator configuration (e.g., `subSwaggers` property) visit [this page](/products/console/api-console/advanced-section/swagger-aggregator/configuration.md).
:::
...
- [change the logo](/runtime-components/applications/api-documentation-aggregator/30_faqs.md#how-can-I-change-the-api-portal-logo-and-favicon)
- [change the API Portal prefix](/runtime-components/applications/api-documentation-aggregator/30_faqs.md#how-can-I-change-the-prefix-of-api-portal-endpoints)
- [authenticate endpoints with OAuth 2.0](/runtime-components/applications/api-documentation-aggregator/30_faqs.md#how-can-i-authenticate-my-endpoints-with-oauth-20)
