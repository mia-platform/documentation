...
Due to licensing [CRUD SQL service](/runtime-components/plugins/crud-sql/10_overview.md) requires packaging with third-party software, unless your DataSource are PostgreSQL or MSSQL databases whose support is already included in the docker image of the plugins.
...
:::info
For a more in-depth description of the configuration, you can refer to the [plugin configuration](/runtime-components/plugins/crud-sql/20_configuration.md).
:::
