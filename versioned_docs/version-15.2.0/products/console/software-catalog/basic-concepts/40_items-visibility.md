...
:::caution
An item based on a **private [ITD](/products/console/software-catalog/basic-concepts/10_items-types.md)** can only have **private visibility**.
:::
...
Since the `visibility` field is not mandatory in the [item data structure](/products/console/software-catalog/basic-concepts/05_items-data-structure.md), an item without it is considered to be private.
