...
| `user`           | `object` | Contains information about the user who triggered the event. The information includes user.id, user.name, and user.email |
...
```json
{
  ...
  "required": ["eventName", "eventTimestamp", "user", "payload"],
  "type": "object"
}
```
...
```json
{
  ...
  "required": ["eventName", "eventTimestamp", "user", "payload", "resource"],
  "type": "object"
}
```
