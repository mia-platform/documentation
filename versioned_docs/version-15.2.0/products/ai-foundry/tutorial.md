...
- Explore [Prompts](/products/ai-foundry/basic-concepts/11_prompt.md) to extract the agent instructions into versioned, reusable templates.
- Add a **parallel** orchestration node to run independent agents concurrently.
- Register an [MCP Server](/products/ai-foundry/basic-concepts/14_mcp-server.md) to give agents access to live data sources such as your ticketing system.
