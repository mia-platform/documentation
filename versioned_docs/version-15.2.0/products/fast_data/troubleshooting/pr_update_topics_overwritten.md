...
This version of the Console introduces an automatic generation of PR update topics, as further explained inside the [Projection page](/products/fast_data/configuration/projections.md#pr-update-topic).
