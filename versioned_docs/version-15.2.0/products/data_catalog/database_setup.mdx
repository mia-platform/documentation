...
Running the CLI inside your project can be done exploiting a K8s cronjob. In this [documentation page](/products/console/api-console/api-design/jobs-cronjob.md)
