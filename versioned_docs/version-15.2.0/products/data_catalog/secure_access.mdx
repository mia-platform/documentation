...
- access to [Data Catalog](/runtime-components/applications/data-catalog/10_overview.md), which automatically
...
:::tip
In case it is needed to [embed Data Catalog solution within Mia-Platform Console](/products/data_catalog/frontend/overview.mdx#embed-as-console-extension),
...
:::note
Before proceeding, be sure to have configured Data Catalog endpoints accordingly to their [specific documentation](/products/data_catalog/data_catalog_open_lineage.mdx#endpoints).
:::
...
| `read:glossary`          | allow visualizing Business Glossary terms and their associations to data assets |
| `admin:glossary`         | allow creating, editing, deleting Business Glossary terms, managing their relations, and associating/dissociating them to data assets |
...
- __job_runner_ui__: page showing the application's [`grpcui`](https://github.com/fullstorydev/grpcui) interacting with the _Job Runner_ service.
  See [here](/products/data_catalog/data_catalog_job_runner.mdx#trigger-job) to learn more about the interactions with _Job Runner_.
:::
