...
The other property, `planBasePath`, has to be set to the endpoint that expose the [Therapy and Monitoring Manager service](/runtime_suite/therapy-and-monitoring-manager/10_overview.md). 
