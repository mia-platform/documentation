...
Once you [created a Company](/console/company-configuration/create-company.md), you can configure:
...
To connect a cluster, you can follow the [clusters connection guide](/console/company-configuration/clusters-management/connect-and-manage-cluster.mdx).
