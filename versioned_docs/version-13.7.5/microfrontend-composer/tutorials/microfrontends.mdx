...
* The [Microfrontend Composer Tutorial Basics](/microfrontend-composer/tutorials/basics.mdx).
* The [Microfrontend Composer Tutorial Templates](/microfrontend-composer/tutorials/templates.mdx).
...
* The [Microfrontend Composer Templates Tutorial](/microfrontend-composer/tutorials/templates.mdx) where we explain how to configure other types of pages using the Microfrontend Composer Page Composer and an iFrame Page.
