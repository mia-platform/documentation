...
|--------------------------------------------------------------------------------|---------------------------------------------------|----------|
| [selected-data](/products/microfrontend-composer/back-kit/70_events.md#selected-data) | Triggers the opening of the modal in edit mod     | The data of the role. Please note that the `_id` is required.         |
| [add-new](/products/microfrontend-composer/back-kit/70_events.md#add-new)                                                                        | Listens to the add-new event to open modal        | -                   |
