...
---
Following we will see how to create a Microservice using the [Console](/products/console/overview-dev-suite.md).

:::info
The following guide is generic, so you can follow it to create any type of Microservice from template.  
You can read [here](/runtime-components/libraries/custom-plugin-lib/apidoc.md) a dedicated guide about creating from the **Node.js Template**
:::
...
In the Console, follow these steps:
 ...
 3. Select a Template and add the Microservice information:
      ...
      * **Docker image name**: the docker image name, you can leave the default one too. You can choose the Container Registry from a dropdown list,
      which contains the [Container Registries configured in the Project Settings](/products/console/project-configuration/project-settings.md#container-registries).
...
Trough the [Log & monitoring section](/products/console/monitoring/introduction.md) you can monitor the status of the related Microservice container
