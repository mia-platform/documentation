...
In this step, you are required to choose the cluster's vendor and runtime service. You can do so by selecting a vendor tab and clicking on the card related to the runtime service you want to use. Further information on the supported vendors and runtime services can be found [here](/products/console/company-configuration/clusters-management/overview.md).
...
To extract it, refer to [this paragraph](/products/console/company-configuration/clusters-management/cluster-setup.mdx#ca-and-token).
