...
Go to **Software Catalog > Type Definitions** to view and explore Catalog [Item Type Definition](/products/console/software-catalog/basic-concepts/10_items-types.md).
...
- **Assets**: this tab displays a JSON representation of the definition [`spec` property](/products/console/software-catalog/items-manifest/overview.md#item-type-definition).
...
Go to **Software Catalog > Items** to view and explore Catalog [items](/products/console/software-catalog/basic-concepts/05_items-data-structure.md).
...
- **Metadata**: this tab presents an initial Details section containing [metadata](/products/console/software-catalog/basic-concepts/05_items-data-structure.md) about the item, including its name, general information, and useful links.
- **Assets**: this tab displays a JSON representation of the [`resources` property](/products/console/software-catalog/items-manifest/overview.md) specific to the item.
...
1. **select the [item type](/products/console/software-catalog/basic-concepts/10_items-types.md)**: choose the type of item you want to create from the available options. This will determine the set of fields and attributes you need to provide during the creation process;

2. **enter [metadata](/products/console/software-catalog/basic-concepts/05_items-data-structure.md)**: fill in the necessary metadata for the item. This typically includes basic information such as the name, description, category, and any other required attributes;

3. **enter [assets](/products/console/software-catalog/items-manifest/overview.md)**: after entering the metadata, you will need to specify additional details (`resources` property) for the item type. A default schema of resources will be provided to assist you in adding the relevant specifics. This schema serves as a template to help ensure all necessary information is included and formatted correctly.
