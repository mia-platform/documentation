...
A **manifest** is a JSON representation of an entity that can be [applied](/products/console/software-catalog/items-management/overview.md) to the Catalog.

## Item Type Definition

The manifest of an [ITD](/products/console/software-catalog/basic-concepts/10_items-types.md) contains metadata about the definition itself and specifications regarding the items of the defined type.
...
[Item](/products/console/software-catalog/basic-concepts/05_items-data-structure.md) manifests partially varies based on the referenced ITD: the **top-level structure** of the manifest is the same for any item, while the content of the **`resources` property** is specific for each ITD.
