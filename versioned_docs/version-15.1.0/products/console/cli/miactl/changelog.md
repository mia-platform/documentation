...
- `miactl context remove` command is available to remove an existing context

### Changed

- `miactl deploy` now supports option `--version` to deploy a project by its version
...
- create cli renderer
- 
[v0.25.2]: https://github.com/mia-platform/miactl/compare/v0.25.1...v0.25.2
