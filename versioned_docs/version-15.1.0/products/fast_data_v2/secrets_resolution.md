...
| Service                                                                                           | Version |
|---------------------------------------------------------------------------------------------------|:-------:|
| [Mongezium](/products/fast_data_v2/mongezium_cdc/20_Configuration.mdx)           | >=0.4.2 |
| [Stream Processor](/products/fast_data_v2/stream_processor/20_Configuration.mdx) | >=0.5.2 |
| [Farm Data](/products/fast_data_v2/farm_data/20_Configuration.mdx)               | >=0.5.3 |
| [Kango](/products/fast_data_v2/kango/20_Configuration.mdx)                       | >=0.5.1 |
