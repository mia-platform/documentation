...
|     `configurations.mongodbUrl`     | string | The connection url to a mongodb server or cluster, more info can be found [here](/requirements/installation-guidelines/console/self-hosted/helm-values/40_mongodb-configurations-and-encryption.md#mongodb-configuration) |         |    ❌     |
