...
For further details on refer to the service's [configuration documentation](/runtime-components/plugins/payment-gateway-manager/60_configuration.md).
...
- [Invoice-Service](/runtime-components/plugins/invoice-service/10_overview.md)
...
The user should perform the additional steps reported below in order to create MongoDB views that enable to exploit the ready to use [backoffice pages related to payments](/runtime-components/applications/payment-integration-hub/40_backoffice_payment.md).
