...
To fully grasp the core concepts discussed on this page, we recommend reviewing the [Fast Data Engine Presentation](./fast_data_engine.md) page before proceeding with these examples.
:::
