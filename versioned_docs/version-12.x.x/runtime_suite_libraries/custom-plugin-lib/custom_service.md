...
Upon `service`, you can you can add [routes](/runtime_suite_libraries/custom-plugin-lib/routes.md) and [decorators](/runtime_suite_libraries/custom-plugin-lib/decorators.md).  
