...
This library simplifies the interaction between a generic microservice and the [Flow Manager](/runtime_suite/flow-manager-service/10_overview.md) service.
...
**Note:** users of [`custom-plugin-lib`](/runtime_suite_libraries/custom-plugin-lib/apidoc.md)
