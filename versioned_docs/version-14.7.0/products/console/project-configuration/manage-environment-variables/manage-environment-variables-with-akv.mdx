...
- `<namespace>` is the namespace where your project will be deployed. it depends on the environment of the project, its value can be retrieved from the [environments page](/products/console/project-configuration/manage-runtime-environments/index.md) in the Console.
