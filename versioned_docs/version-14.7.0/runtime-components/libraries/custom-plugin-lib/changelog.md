...
- Update @mia-platform/lc39 2.2.2 -> 3.1.0.
    ...
    * Request and response logged information are now compliant with Mia-Platform logging guidelines. To see the guidelines, please check [Mia Platform Docs](/products/console/api-console/api-design/guidelines-for-logs.md). You can find the implementation details [here](https://github.com/mia-platform/lc39/blob/master/lib/custom-logger.js)
