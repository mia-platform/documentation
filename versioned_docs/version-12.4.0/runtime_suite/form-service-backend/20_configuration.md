...
The options can be updated for example updated with a [POST decorator](/development_suite/api-console/api-design/plugin_baas_4.md#pre-and-post-decorators) after the submission of a new form.
