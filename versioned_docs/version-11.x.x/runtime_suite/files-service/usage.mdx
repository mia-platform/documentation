...
The body must be a JSON containing the fields you want to modify.
...
Fields not specified in the patch will be left untouched.
The endpoint will return the modified document in the body:
