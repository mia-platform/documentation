...
:::info
[ndjson](https://en.wikipedia.org/wiki/JSON_streaming#Newline-delimited_JSON) is a format that ensures the streaming of data structures, where each record is processed individually and separated by a newline (`\n`) delimiter.
