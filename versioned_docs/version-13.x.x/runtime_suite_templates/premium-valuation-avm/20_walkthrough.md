...
A more detailed description on how to use our `custom-plugin-lib` to define the behavior of your microservice in response to an HTTP request can be found in [its related section](/development_suite/api-console/api-design/plugin_baas_4.md) of Mia-Platform documentation.
