...
If you want to discover more, head to the [dedicated section](/old_software-catalog/manage-items/overview.md#set-controlled-versions-for-your-marketplace-resources-and-make-them-available-to-users) inside the [Company Marketplace](/old_software-catalog/manage-items/overview.md) documentation page.
