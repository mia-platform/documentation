...
For more information and to see the currently supported resources, please refer to the [documentation](/old_software-catalog/overview.md) for detailed insights on the Software Catalog.
