...
To discover more about this feature, go to the [respective documentation](/old_software-catalog/manage-items/mia-ctl/create/create-item-by-type/create_infrastructure_resource.mdx#generate-dynamic-form-of-the-to-customize-validation-of-your-infrastructure-resource).
