...
:::info
Please note that, in the next year, new Projects will **exclusively** be created with the Enhanced Workflow, fostering better performances and leveraging features such as GitOps, Custom Orchestrators and quicker configuration save time!
