...
Fast Data Control Plane UI can be embedded as an extension of Mia-Platform Console using [Mia-Platform Platforge](/release-notes/v13/mia-platform-v13#platforge-enhance-extensibility).
