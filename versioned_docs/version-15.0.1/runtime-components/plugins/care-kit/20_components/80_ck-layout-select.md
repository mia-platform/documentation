...
| `label` | [LocalizedText](/products/microfrontend-composer/back-kit/40_core_concepts.md#localization-and-i18n) | The label displayed in the select|
