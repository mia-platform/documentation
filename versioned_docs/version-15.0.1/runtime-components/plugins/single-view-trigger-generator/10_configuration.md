...
To learn more about the Single View Trigger Generator and its configuration, you can read [its documentation in the Fast Data area](/products/fast_data/configuration/single_view_trigger_generator.mdx).
