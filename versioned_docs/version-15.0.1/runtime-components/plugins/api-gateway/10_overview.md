...
:::info
Let's check the [configuration directories](/runtime-components/plugins/api-gateway/20_configuration.md#configuration-directories) and the [advanced configuration](/products/console/api-console/advanced-section/api-gateway/how-to.md) to more details.
:::
