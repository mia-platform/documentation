...
In addition, after each upload it saves the file's information using the [CRUD Service](/runtime-components/plugins/crud-service/20_configuration.md) on a configurable mongoDB collection (usually files).
