...
The pages are fully customizable, and they can be modified to implement a new functionalities and adapt to specific needs; for more details on how to configure the pages you can refer to [backoffice documentation](/products/microfrontend-composer/overview.md).
...
It is also possible to define them as templates in your own project following this [guide](/products/microfrontend-composer/composer/30_configurator_settings.md#template-sources), the URL to insert is `https://raw.githubusercontent.com/Mia-FinTech/scoring-backoffice/main/`.
