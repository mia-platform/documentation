...
- The delivery pipeline has to be up-to-date and with no error notifications. Visit our page about [how to setup a pipeline](/requirements/installation-guidelines/console/self-hosted/pipeline-configuration.md) for more details;
