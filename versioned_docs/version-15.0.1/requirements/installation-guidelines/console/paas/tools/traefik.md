...
To configure TLS capabilities in the PaaS, you can check our Cert-Manager [Documentation](/requirements/installation-guidelines/console/paas/tools/cert-manager.md).
...
Be aware that this feature will only be available if you are using the [Envoy API Gateway](/runtime-components/plugins/envoy-api-gateway/overview.md). 

If you are using the [Nginx API Gateway](/runtime-components/plugins/api-gateway/10_overview.md), or you want to edit the hosts used for exposing the APIs from your Project, you will need to manually edit the `default.ingressroute.yml` file.
:::
