...
There are no specific configurations for MongoDB integration since the connection string is obtained via the `configurations.mongodbUrl` configuration value; more information can be found [here](/requirements/installation-guidelines/console/self-hosted/helm-values/40_mongodb-configurations-and-encryption.md#mongodb-configuration).
