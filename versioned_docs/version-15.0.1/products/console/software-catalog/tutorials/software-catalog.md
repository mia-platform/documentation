...
In this tutorial, we will learn how to publish a new item on your own company's Catalog and manage its lifecycle using the [Software Catalog](/products/console/software-catalog/overview.md).
...
For creating an item with different visibility levels, refer to [this guide](/products/console/software-catalog/basic-concepts/40_items-visibility.md).
To learn more about the different item types available in the Mia-Platform Catalog, see [this guide](/products/console/software-catalog/basic-concepts/10_items-types.md).
...
4. **Enter Metadata** – Fill in basic details like:
   ...
   4. `Lifecycle Status` - for a detailed explanation of all the options, refere to [this guide](/products/console/software-catalog/basic-concepts/30_items-lifecycle.md)
...
For a detailed explanation of the required metadata please refere to [this guide](/products/console/software-catalog/items-manifest/overview.md).
...
To know more about how to create new version for Catalog read the dedicated [documentation page](/products/console/software-catalog/items-management/ui.md#create-a-new-version).
...
To know more about how to update a Catalog component using miactl read this [documentation page](/products/console/software-catalog/items-management/miactl.md).
...
However, as the number of components grows, managing everything manually becomes impractical. In such cases, miactl enables a [declarative and automated approach](/products/console/software-catalog/items-management/miactl.md#declarative-approach) to handling all Catalog components efficiently.
