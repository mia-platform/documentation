...
Managing your Catalog boils down to permforming CRUD operations on [Item Type Definitions](/products/console/software-catalog/basic-concepts/10_items-types.md) and [items](/products/console/software-catalog/basic-concepts/05_items-data-structure.md).
