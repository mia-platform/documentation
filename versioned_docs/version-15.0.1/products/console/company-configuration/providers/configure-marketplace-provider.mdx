...
For more information about how to share a Marketplace Resource, please refer to the [dedicated documentation page](/products/console/software-catalog/overview.md).
...
The process of connecting a Provider for Marketplace is similar to the one described in the [Connect a Provider](/products/console/company-configuration/providers/configure-provider.mdx#connect-a-provider) section, with only small differences in the first and second steps.
...
First step is the same as the one described in the [Connect a Provider Step 2](/products/console/company-configuration/providers/configure-provider.mdx#step-1-provider-services) section with only one difference:
...
This step is the same as the one described in the [Connect a Provider](/products/console/company-configuration/providers/configure-provider.mdx#step-2-provider-details) section with a **very important difference**:  
...
This step has no differences with the [Connect a Provider Step 3](/products/console/company-configuration/providers/configure-provider.mdx#step-3-credentials).

### Step 4: Advanced

This step has no differences with the [Connect a Provider Step 4](/products/console/company-configuration/providers/configure-provider.mdx#step-4-advanced).

## Edit a Provider for Marketplace

It is possible to edit the provider for marketplace as [showed here](/products/console/company-configuration/providers/configure-provider.mdx#edit-a-provider).
