...
in the [project blueprint page](/products/console/company-configuration/project-blueprint.md).
:::
...
- **repository** (_required_):
  ...
  :::info
  This field can also be set by [selecting a default Git Provider](/products/console/company-configuration/providers/configure-provider.mdx#set-a-default-provider) in the **Providers** section of the Console.
  :::
  ...
  - **providerId** (_required_): the unique identifier of the Git Provider associated with the Company
    ...
    Check out the complete list of [supported providers](/products/console/company-configuration/providers/configure-provider.mdx);
  ...
  - **basePath**: the base path where the Project will be created.
    ...
    <TabItem value="bitbucket-cloud" label="Bitbucket Cloud">
      ...
      It corresponds to the **workspace name** in Bitbucket Cloud.

      For example, if your workspace is reachable at the URL **`https://bitbucket.org/mia-platform`**, <br/>
      then the `basePath` must be **`mia-platform`**.
...
- **pipelines** (_required_):
  ...
  :::info
  This field can also be set by [selecting a default CI/CD Tool](/products/console/company-configuration/providers/configure-provider.mdx#set-a-default-provider) in the **Providers** section of the Console.
  :::
  ...
  - **type** (_required_): one of the supported provider types. Check out the complete list of [supported providers](/products/console/company-configuration/providers/configure-provider.mdx).
...
- **environmentsVariables**:
  ...
  :::info
  This field can also be set by [selecting a default Secret Manager](/products/console/company-configuration/providers/configure-provider.mdx#set-a-default-provider) in the **Providers** section of the Console.
  :::
...
- **logicalScopeLayers**:
  ...
  The `logicalScopeLayers` field will be created in the project model according to the project `layerId` value. Please refer to the [Create a Project](/products/console/project-configuration/create-a-project.mdx) section for further details.
...
- **dockerImageNameSuggestion**:
  ...
  :::info
  This suggestion will appear in the `Docker Image Name` field when you [create a microservice](/products/console/api-console/api-design/services.md#how-to-create-a-microservice-from-an-example-or-from-a-template).
  :::
