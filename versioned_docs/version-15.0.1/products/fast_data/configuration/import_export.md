...
:::caution
Some Fast Data resources, such as **Projections**, can be imported as a reference __only in Projects that are using the [Single View Trigger Generator architecture](/products/fast_data/concepts/architecture.md#event-driven-architecture)__. Please check your services before importing the resources.
:::
...
When should I use the Import / Export functionality? Please visit the [FAQ page](/products/fast_data/faq/import_export_faq.md) for Import / Export to know the answer to this and other question related to the feature.