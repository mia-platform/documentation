...
Fast Data solution can either be installed in a [PaaS](/requirements/installation-guidelines/console/paas/overview.md) or [Self-Hosted](/requirements/installation-guidelines/console/self-hosted/self-hosted-requirements.md) setup. The goal of this guide is to provide best practices that are independent of the infrastructure.
