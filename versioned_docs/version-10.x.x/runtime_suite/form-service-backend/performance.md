...
We ran some tests to evaluate the response time and size of the [form data CSV export](overview.md#form-data-csv-export), available since version **1.7.0**, using a basic form with five fields: first name, last name, gender, email address and phone number.
