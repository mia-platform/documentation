...
Permissions can then be used in ACL expressions as describe [here](/products/console/api-console/api-design/endpoints.md#manage-the-security-of-your-endpoints).
