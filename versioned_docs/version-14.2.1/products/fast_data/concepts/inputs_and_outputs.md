...
When entering our systems, the message is read by the [Kafka Message Adapter](/products/fast_data/configuration/realtime-updater/configuration-files.md#kafka-adapters-kafka-messages-format) of the Real-Time Updater, which uses it to update the Projections.
...
You can also specify a [custom adapter](/products/fast_data/configuration/realtime-updater/configuration-files.md#custom) to handle any other message formats you need.
...
**Consumer**: Single View Trigger Generator or Single View Creator ([sv-patch](/products/fast_data/configuration/single_views.md#single-view-patch))
...
This version of Projection Record update is emitted by [Real-Time Updater](/products/fast_data/realtime_updater.md).
...
This version of Projection Record update is emitted by [Projection Storer](/products/fast_data/projection_storer.md).
