...
1. **Save the changes by committing**. Please, take a quick look at [Mia-Platform handbook](/products/console/handbooks/project-usage.md#save-changes) first.
