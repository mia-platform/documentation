...
In this tutorial we will see how to add this [authorization layer](/products/console/api-console/api-design/authorization.md) to our [Endpoints](/products/console/api-console/api-design/endpoints.md).
...
If you don't have it yet, you can easily set it up following the [Create a Rest API in 5 minutes](/products/console/tutorials/configure-marketplace-components/rest-api-for-crud-on-data.mdx) guide
