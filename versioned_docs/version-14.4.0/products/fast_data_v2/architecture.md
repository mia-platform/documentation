...
To fully grasp the core concepts discussed on this page, we recommend reviewing the [Fast Data Engine Presentation](/products/fast_data_v2/architecture.md) page before proceeding with these examples.
:::
