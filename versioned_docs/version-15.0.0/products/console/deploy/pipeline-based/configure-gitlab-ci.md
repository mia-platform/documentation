...
For projects that are not using Enhanced Workflow, you can use the standard `.deploy_job` extension with the generic `deploy-job.yml` template as shown in the example below:
