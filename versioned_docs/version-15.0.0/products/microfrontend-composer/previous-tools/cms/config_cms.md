...
* *Gallery* is instead the perfect representation for images. Follow the [link](/products/microfrontend-composer/previous-tools/cms/conf_cms.md#9-configure-the-gallery) to see how to configure it.
