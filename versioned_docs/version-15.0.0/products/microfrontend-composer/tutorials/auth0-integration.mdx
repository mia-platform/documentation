...
Before starting this tutorial, you should be familiar with the concepts of the [Mia-Platform Microfrontend Composer](/products/microfrontend-composer/overview.md).
We also recommend to complete the [Microfrontend Composer Tutorial Basics](/products/microfrontend-composer/tutorials/basics.mdx).

## Create the necessary Microservices

Create the [Secure API Gateway](/runtime-components/applications/secure-api-gateway/10_overview.md) application:
...
In order to handle the users on `Auth0`, you need to add the [User Manager Service](/runtime-components/plugins/user-manager-service/10_overview.md):
...
You can follow this page: [API Gateway Configuration](/runtime-components/applications/secure-api-gateway/20_configuration.md#api-gateway).
...
You can follow this page: [Authorization Service Configuration](/runtime-components/applications/secure-api-gateway/20_configuration.md#authorization-service).
...
In order to configure the `auth0-client`, the first step is to setup the **Auth0 Tenant**. You can follow this page: [Configure Auth0](/runtime-components/plugins/auth0-client/30_configure_auth0.md) (for the scope of this tutorial you can avoid steps 3 and 4).
...
You can configure `user-manager-service` following this page: [User Manager Service Configuration](/runtime-components/plugins/user-manager-service/10_overview.md).
...
With all the configurations in place, save your changes and then deploy. For further details on the deploy command, consult the [Console Handbook](/products/console/handbooks/project-usage.md).
...
* In the [Microfrontend Composer Templates Tutorial](/products/microfrontend-composer/tutorials/templates.mdx), explore how to configure various page types with the Microfrontend Composer Page Composer and an iFrame Page.
* The [Microfrontend Composer Microfrontends Tutorial](/products/microfrontend-composer/tutorials/microfrontends.mdx) provides guidance on configuring a Microfrontend using Angular or React, and its integration into the Microfrontend Composer.
