...
The other property, `planBasePath`, has to be set to the endpoint that expose the [Therapy and Monitoring Manager service](/runtime-components/plugins/therapy-and-monitoring-manager/10_overview.md). 
...
|[change-query](/products/microfrontend-composer/back-kit/70_events.md#change-query)| used to updated the filters with the `planId` selected|
