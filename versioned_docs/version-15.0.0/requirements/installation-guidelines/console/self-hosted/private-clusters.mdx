...
* Insert the proxy's URL and, if you need it, a TLS certificate, as reported in [this documentation page](/products/console/company-configuration/clusters-management/connect-and-manage-cluster.mdx#step-4-advanced).

![Add cluster connection 4](../../../../products/console/company-configuration/clusters-management/img/add-cluster-connection-4.png)
...
:::info
The cluster the Mia-Platform Console is installed on strictly depends on your Mia-Platform license ([PaaS](/requirements/installation-guidelines/console/paas/overview.md), [BYOI](/requirements/installation-guidelines/console/byoi/overview.md) or [Self hosted](/requirements/installation-guidelines/console/self-hosted/self-hosted-requirements.md)).
...
`mlp` is a command line tool we use to deploy on Kubernetes, look at the [dedicated documentation page](/runtime-components/tools/mlp/10_overview.md) for more.
