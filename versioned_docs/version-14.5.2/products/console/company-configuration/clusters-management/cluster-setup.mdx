...
<Tabs queryString="type">
  ...
  After adding the necessary permissions follow this [guide](/products/console/design-your-projects/custom-resources/custom-resources.md) to see your custom resources in the Console.
