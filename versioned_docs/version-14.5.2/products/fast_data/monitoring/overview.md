...
If you are planning to use Prometheus Operator as a monitoring system for your project, you can automatically generate and configure the `servicemonitor.yml` files for all the monitoring services using their [Metrics card](/products/console/api-console/api-design/microservice-monitoring.md).
...
Kafka exporter service configuration is quite easy, the only thing you need to do is make sure the variables in the [Microservice configuration - Args](/products/console/api-console/api-design/services.md#microservice-configuration) section are properly defined.
...
- [Bucket Storage Support Dashboard](/products/fast_data/monitoring/dashboards/bucket_storage_support.md)
- [Debezium CDC Dashboard](/products/fast_data/monitoring/dashboards/debezium_cdc.md)
- [Kafka Messages Dashboard](/products/fast_data/monitoring/dashboards/kafka_messages.md)
- [Projection Changes Dashboard](/products/fast_data/monitoring/dashboards/projection_changes.md)
- [Ingestion services Dashboard](/products/fast_data/monitoring/dashboards/ingestion_services.md)
- [Single Views Dashboard](/products/fast_data/monitoring/dashboards/single_views.md)
- [Unmapped fields Dashboard](/products/fast_data/monitoring/dashboards/unmapped_fields.md)
