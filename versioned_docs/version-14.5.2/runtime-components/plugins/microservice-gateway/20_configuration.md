...
:::info
The Microservice Gateway supports custom CA certs. If you want to learn more about these certificates and how to configure them in your Microservice Gateway visit [this page](/products/console/api-console/api-design/services.md#provide-a-ca-certificate-to-a-custom-service)
:::
...
- the `router`, where you can define the basics of each [endpoint](/products/console/api-console/api-design/endpoints.md#what-is-an-endpoint),
  and attach a [`pre` and `post` decorator](/runtime-components/plugins/microservice-gateway/10_overview.md#pre-and-post-hooks);
