...
- [Mia-Platform Console](/runtime-components/plugins/integration-connector-agent/sources/15_console.md)
- [Jira](/runtime-components/plugins/integration-connector-agent/sources/20_jira.md)
- [GitHub](/runtime-components/plugins/integration-connector-agent/sources/20_github.md)
- [GCP Asset Inventory from Pub/Sub](/runtime-components/plugins/integration-connector-agent/sources/30_gcp_pubsub_asset_inventory.md)
- [AWS CloudTrail from SQS](/runtime-components/plugins/integration-connector-agent/sources/50_aws_cloudtrail_sqs.md)
- [Azure Activity Log from EventHub](/runtime-components/plugins/integration-connector-agent/sources/40_azure_activity_log_event_hub.md)

The supported **Sinks** are:

- [Mia-Platform Console Catalog](/runtime-components/plugins/integration-connector-agent/sinks/15_console-catalog.md)
- [Mia-Platform CRUD Service](/runtime-components/plugins/integration-connector-agent/sinks/30_crudservice.md)
- [MongoDB](/runtime-components/plugins/integration-connector-agent/sinks/20_mongodb.md)
