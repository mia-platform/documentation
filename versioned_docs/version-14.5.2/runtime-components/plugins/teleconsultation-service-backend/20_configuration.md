...
| **CRUD_SERVICE_URL**                     | No      | http://crud-service       | 1.0.0           | Base url of the Crud service API.                                                                                      |
| **CRUD_SERVICE**                     | No      | crud-service       | 1.0.0           | Base url of the Crud service API.                                                                                         |
...
| **DEFAULT_RECORDING_TYPE**      | No       | `none` | 2.1.0          | Defines the default recording type for teleconsultations. Allowed values are `manual`, `automatic`, or `none`.                                                                                                         |
| **TRANSCRIPTION_MAX_FILE_SIZE**      | No       | `50MB` | 2.1.0          | Max size supported for the transcription file.                                                                                                        |
...
[usage-virtual-background]: /runtime-components/plugins/teleconsultation-service-backend/30_usage.md#post-settingsbackground-image
