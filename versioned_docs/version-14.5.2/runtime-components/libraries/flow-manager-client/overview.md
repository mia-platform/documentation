...
This library simplifies the interaction between a generic microservice and the [Flow Manager](/runtime-components/plugins/flow-manager-service/10_overview.md) service.
...
**Note:** users of [`custom-plugin-lib`](/runtime-components/libraries/custom-plugin-lib/apidoc.md)
